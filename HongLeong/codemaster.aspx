<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="codemaster.aspx.vb" Inherits="codemaster_class" %>
            ...
            <div class="row listpage">
                ...
                <div class="col-md-10 bg-white">
                    <div style="padding-top: 1em;">
                            ...
                            <tr>
                                ...
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cm_code" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Description&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cm_description" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <input type="hidden" runat="server" id="codegroup" name="codegroup" />
                    </div>
                </div>
            </div>
        </div>
