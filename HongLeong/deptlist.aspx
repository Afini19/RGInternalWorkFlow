<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="deptlist.aspx.vb" Inherits="deptlist_class" %>
                        ...
                        <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;" class="cssdetail">Department Name</th>
                                    ...
                                    <ItemTemplate>
                                        <tr id="trRow" class="ui-widget-content" runat="server">
                                            ...
                                            <td class="cssdetail" style="border-bottom: solid 1px silver" width="20%">
                                                <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "de_id")%>' CommandName="Edit">Edit</asp:LinkButton>
                                                <asp:Literal ID="litSepDel" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "de_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure want to delete this record with its category and module?')">Delete</asp:LinkButton>
                                                <asp:Literal ID="Literal1" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkRights" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "de_id")%>' CommandName="viewCat">View Category</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
