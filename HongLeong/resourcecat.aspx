...
<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="resourcecat.aspx.vb" Inherits="rescat_class" %>
...
<ul>   
<li><a href="#tabs-1">Resource Booking : Category</a></li>    
</ul>  
<div id="tabs-1">
<table width="100%">
...
<tr><td class="cssdetail" valign="top" align="left" width="200">Category code&nbsp;<font class="cssrequired">*</font></td><td colspan="1" class="cssdetail"  valign="top" align="left"><asp:TextBox ID="rec_code" runat="server"  style="width:150px" Maxlength="20" class="validate[required]" ></asp:TextBox></td></tr>
<tr><td class="cssdetail" valign="top" align="left" width="200">Category name</td><td colspan="1" class="cssdetail"  valign="top" align="left"><asp:TextBox ID="rec_name" runat="server"  style="width:300px" Maxlength="50"  ></asp:TextBox></td></tr>
