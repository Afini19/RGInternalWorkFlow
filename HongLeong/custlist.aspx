<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="custlist.aspx.vb" Inherits="custlist_class" %>
                        ...
                        <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;" class="cssdetail">Customer Name</th>
                                    ...
                                    <ItemTemplate>
                                        <tr id="trRow" class="ui-widget-content" runat="server">
                                            ...
                                            <td class="cssdetail" style="border-bottom: solid 1px silver" width="20%">
                                                <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "cu_id")%>' CommandName="Edit">Edit</asp:LinkButton>
                                                <asp:Literal ID="litSepDel" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "cu_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure want to delete this record?')">Delete</asp:LinkButton>
