<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="module.aspx.vb" Inherits="module_class" %>
                            ...
                            <tr>
                                ...
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="mod_code" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="mod_description" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                        </table>
