<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="wdocs.aspx.vb" Inherits="wdocs_list_class" %>
...
<meta charset="utf-8">
<title>Support System : Category</title>
...
<asp:Button ID="btn1" Text="Pending" Runat="server" OnClick="shortcut1" style="width:160px" CausesValidation="false" UseSubmitBehavior="false" /><br />
<asp:Button ID="btn2" Text="Approved" Runat="server" OnClick="shortcut2" style="width:160px" CausesValidation="false" UseSubmitBehavior="false" /> <br />
<asp:Button ID="btn3" Text="Cancelled" Runat="server" OnClick="shortcut3" style="width:160px" CausesValidation="false" UseSubmitBehavior="false" /> <br />
<asp:Button ID="btn5" Text="Rejected" Runat="server" OnClick="shortcut4" style="width:160px" CausesValidation="false" UseSubmitBehavior="false" /> <br /><br />
