<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="w.aspx.vb" Inherits="w_class" %>
                ...
                <div class="col-md-10 bg-white">
                    <div style="padding-top: 1em;">
                        ...
                        <table class="table table-borderless" width="100%" style="margin-top: -15px" cellpadding="0" cellspacing="2">
                            <tr>
                                <td class="cssdetail" valign="top" align="left" width="20%">Classification&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="wf_classification" runat="server" Style="width: 80%"></asp:DropDownList>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Workflow Code&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="wf_code" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Workflow Name&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="wf_name" runat="server" Style="width: 80%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                        </table>
