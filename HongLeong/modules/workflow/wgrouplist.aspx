<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="wgrouplist.aspx.vb" Inherits="wgroup_list_class" %>
                        ...
                        <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;" class="cssdetail">Workflow</th>
                                ...
                                <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand">
                                    <ItemTemplate>
                                        <tr id="trRow" class="ui-widget-content" runat="server">
                                            <td align="center" class="cssdetail" style="border-bottom: solid 1px silver">
                                                <asp:Literal ID="litNo" runat="server" Text='<%# Container.ItemIndex + 1 %>'></asp:Literal>
                                            </td>
                                            <td align="left" class="cssdetail" width="48px" style="border-bottom: solid 1px silver" valign="top">
                                                <div>
                                            ...
                                            <td class="cssdetail" style="border-bottom: solid 1px silver">
                                                <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "wo_id")%>' CommandName="Edit">Edit</asp:LinkButton>
                                                <asp:Literal ID="litSepDel" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "wo_id")%>' CommandName="Del" OnClientClick="return confirm('Are you sure want to delete this record?')">Del.</asp:LinkButton>
                                                <asp:Literal ID="Literal1" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkRights" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "wo_id")%>' CommandName="Rights">Assign Users</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
