...
Partial Public Class stS_class
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        listingpage = "stS_list.aspx"
        _FormsName = "Support Ticket"
        ...
        If Page.IsPostBack = False Then
            lbltaskno.Text = "<b>Auto Generated</b>"
            ...
            cus_department.DataValueField = "de_name"
    ...
    Public Overrides Function LoadData() As Boolean
        ...
        Try
            ...
            For Each dr In ds.Tables("datarecords").Rows
                ...
                cus_ticketTitle.Text = dr("cus_ticketTitle") & ""
                cus_date.Textdmy = dr("cus_createdt").ToString.Trim
                cus_department.Text = dr("cus_department") & ""
                cus_department_SelectedIndexChanged(Me, EventArgs.Empty)
                cus_category.Text = dr("cus_category") & ""
                cus_category_SelectedIndexChanged(Me, EventArgs.Empty)
                cus_module.SelectedValue = dr("cus_module") & ""
                cus_issuetype.Text = dr("cus_issuetype") & ""
                cus_customer.SelectedValue = dr("cus_customer") & ""
                cus_stno.Text = dr("cus_stno") & ""
    ...
    Private Sub savedatadata(ByVal pWorkflowAction As Boolean, ByVal pType As String)
        ...
        If cus_category.SelectedIndex < 0 Then
            lcus_category = ""
        Else
            lcus_category = cus_category.SelectedItem.Value
        End If
        ...
        Try
            If rid.Value = "" Then
                ...
                lDocno = WebLib.GetDocNo(NmSpace, "cus_taskno", APPCode) & ""
                If lDocno.Trim = "" Then
                    lblMessage.Text = WebLib.getAlertMessageStyle("Task No. Not Set")
                    Exit Sub
                End If
                ...
                insertfields = insertfields & ",cus_taskno"
                insertvalues = insertvalues & ",'" & lDocno & "'"
                insertfields = insertfields & ",cus_title"
                insertvalues = insertvalues & ",'" & cus_title.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_ticketTitle"
                insertvalues = insertvalues & ",'" & cus_ticketTitle.Text.Replace("'", "''") & "'"
                ...
                insertfields = insertfields & ",cus_issuetype"
                insertvalues = insertvalues & ",'" & cus_issuetype.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_customer"
                insertvalues = insertvalues & ",'" & cus_customer.SelectedValue & "'"
                insertfields = insertfields & ",cus_stno"
                insertvalues = insertvalues & ",'" & cus_stno.Text.Replace("'", "''") & "'"
            ...
            Else
                ...
                End If
                If cus_ticketTitle.Enabled = True Then
                    insertvalues = insertvalues & ",cus_ticketTitle='" & cus_ticketTitle.Text.Replace("'", "''") & "'"
                End If
                ...
                End If
                If cus_issuetype.Enabled = True Then
                    insertvalues = insertvalues & ",cus_issuetype='" & cus_issuetype.Text.Replace("'", "''") & "'"
                End If
                If cus_customer.Enabled = True Then
                    insertvalues = insertvalues & ",cus_customer='" & cus_customer.SelectedValue & "'"
                End If
                If cus_stno.Enabled = True Then
                    insertvalues = insertvalues & ",cus_stno='" & cus_stno.Text.Replace("'", "''") & "'"
                End If
