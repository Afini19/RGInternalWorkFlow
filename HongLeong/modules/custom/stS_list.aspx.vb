...
Partial Public Class stS_list_class
    Inherits listpage
    'Generated by VI FEANDI SOFTLABS FORM GENERATOR (http://www.vifeandi.net) VER 2014.1
    Private FORMCODE As String = "STS"  'Hardcoded for customised form
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "Support Ticket - Support Issue"
        'columnscount = "10"
        ...
        'pFieldNames = " workflowstatus.*,zcustom_stS.*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") "
        ...
        End If
        bid.Value = "zcustom_stS"

        Call InitLoad()

        btnback.Visible = False
        Redirector.PrevURL1 = "modules/custom/stS_list.aspx"
        btnadd.Visible = True
