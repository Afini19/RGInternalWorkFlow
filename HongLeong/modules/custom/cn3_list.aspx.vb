...
Partial Public Class cn3_list_class
    Inherits listpage
    'Generated by VI FEANDI SOFTLABS FORM GENERATOR (http://www.vifeandi.net) VER 2014.1
    Private FORMCODE As String = "CN3"  'Hardcoded for customised form
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "CREDIT NOTE REQUISITION FORM"
        'columnscount = "10"
        ...
        pFieldNames = " workflowstatus.*," & TableName & ".*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") " &
			",isnull(IIF(cus_cndnamt='0.00', iif(CONVERT(DATE, convert(VARCHAR(4),cus_cndnyear)+'-'+CAST(cus_cndnmth AS VARCHAR(2))+'-'+convert(VARCHAR(2),'01'))>'2018-05-31',convert(varchar, (select convert(decimal(22,2),sum(cus_amount) * 1.00) from zcustom_docitems where cus_uid=cus_ucode)), convert(varchar, (select convert(decimal(22,2),sum(cus_amount) * 1.06) from zcustom_docitems where cus_uid=cus_ucode))),cus_cndnamt), cus_cndnamt) as cus_cndnamtcount "
        ...
        If Page.IsPostBack = False Then
            ...
            _searchfilter = " wst_status='Pending' and (cus_createby='" & WebLib.LoginUser & "' or '" & WebLib.LoginUser & "' in (" & clsWorkflow.getUserCodebyWorkFlowSQL("wst_workflowid", "wst_level") & ")) and cus_type='" & FORMCODE & "'"
        Else
            _searchfilter = " cus_type='" & FORMCODE & "'"
        ...
        Redirector.PrevURL1 = "modules/custom/cn3_list.aspx"
       ' btnadd.Visible = True
