<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="tempcl_list.aspx.vb" Inherits="tempcl_list_class" %>
                    ...
                    <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                        <thead>
                            <tr>
                                ...
                                <th class="cssdetail">Proposed TCL</th>
                            ...
                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand">
                                <ItemTemplate>
                                    <tr id="trRow" class="ui-widget-content" runat="server">
                                        ...
                                        <td class="cssdetail" style="border-bottom: solid 1px silver">
                                            <asp:Literal ID="Literal6" runat="server" Text='<%# WebLib.formatthemoney(DataBinder.Eval(Container.DataItem, "cus_amttemp")) %>'></asp:Literal>
                                        </td>
                                        <td class="cssdetail" style="border-bottom: solid 1px silver">
