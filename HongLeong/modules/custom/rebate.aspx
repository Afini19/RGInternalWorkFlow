<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="rebate.aspx.vb" Inherits="rebate_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">Subject&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_company" runat="server" Style="width: 100%" MaxLength="100" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                           ...
                           <%-- <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAPget().tostring.trim <> "1" And Not backend.closed(ucode.Value) then %>--%>
