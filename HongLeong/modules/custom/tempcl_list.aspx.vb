...
Partial Public Class tempcl_list_class
    Inherits listpage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        pFieldNames = " workflowstatus.*,zcustom_tempcl.*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") "
        ...
        End If
        bid.value = "zcustom_tempcl"


        Call InitLoad()

        btnback.visible = False
        Redirector.PrevURL1 = "modules/custom/tempcl_list.aspx"
        btnadd.Visible = True
    ...
    Protected Sub rep_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rep.ItemDataBound
        ...
        '    lCode = lCode & "<tr><td class=""cssdetail"">Proposed TCL</td><td class=""cssdetail"">:</td><td class=""cssdetail"">" & WebLib.formatthemoney(drv.Row("cus_amttemp").ToString.Trim) & "</td></tr>"
