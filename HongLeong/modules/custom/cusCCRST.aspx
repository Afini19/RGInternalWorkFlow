<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="cusccrST.aspx.vb" Inherits="cusccrc_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_complainttype" runat="server" Style="width: 100%" AutoPostBack="true" Enabled="false"></asp:DropDownList><%-- ValidationGroup="1-"--%>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <%If lvlvalid.Value = "True" And wfb_bar.wlevelAPget().ToString.Trim = "2" Then %>
                            ...
                            <%If lvlvalid.Value = "True" And wfb_bar.wlevelAPget().ToString.Trim = "3" Then %>
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row mb-1">
                            ...
                            <%If lvlvalid.Value = "True" And wfb_bar.wlevelAPget().ToString.Trim = "6" Then %>
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        <%--<div class="col-md-6">
