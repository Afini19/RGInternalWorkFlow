                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="text-align: right;">CR No :&nbsp;<asp:Label ID="lblcrno" runat="server"></asp:Label></div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row mb-1" hidden="hidden">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_title" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="false" Visible="false">Customer CR</asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Type of CR&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_crtype" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="false">Customer CR</asp:TextBox>
                                    </div>
                                </div>
                            </div>
...
<%--                                        <asp:DropDownList ID="cus_department" runat="server" CssClass="validate[required]" Width="100%" ValidationGroup="1-" AutoPostBack="true" OnSelectedIndexChanged="cus_department_SelectedIndexChanged"></asp:DropDownList>--%>
                                        <asp:DropDownList ID="cus_department" runat="server" CssClass="validate[required]" Width="100%" ValidationGroup="1-" AutoPostBack="false" ViewStateMode="Enabled"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
...
<%--                                        <asp:DropDownList ID="cus_category" runat="server" Style="width: 100%" ValidationGroup="1-" CssClass="validate[required]" AutoPostBack="true" OnSelectedIndexChanged="cus_category_SelectedIndexChanged"></asp:DropDownList>--%>
                                        <asp:DropDownList ID="cus_category" runat="server" CssClass="validate[required]" Width="100%" ValidationGroup="1-" AutoPostBack="false" ViewStateMode="Enabled"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 ...
                                 <div class="col-md-8">
                                     <div class="validation-content" style="position: relative;">
                                         ...
                                         <li class="nav-item dropdown">
                                            ...
                                            <select id="cus_category" style="width:100%;" runat="server" data-live-search="true" class="validate[required]"></select>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Customer&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_customer" runat="server" Style="width: 100%" ValidationGroup="1-" class="validate[required]"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>

                            <div class="row mb-1">
                                <div class="col-md-4">Initiator's name&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_initiator" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>

                            <div class="row mb-1">
                                <div class="col-md-4">Customer phone number&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_contactno" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
...
<%--                            <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAget().tostring.trim <> "1" And Not backend.closed(uid.Value) then %>--%>
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row mb-1">
                                        <div class="col-md-3">Development due date&nbsp;<font class="cssrequired">*</font></div>
                                        <div class="col-md-7">
                                            <div class="validation-content" style="position: relative;">
                    ...
                    <div class="col-md-4 bg-white" style="font-size: 0.8rem;">
                        ...
                        <div class="row mb-1">
                            <div class="col-md-12">
                                <b>* CR Draft only valid for 30 days</b>
                            </div>
                        </div>
                        <%End if %>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#cus_department', function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    //    $("#cus_category").append($("<option></option>").val(this['Value']).html(this['Text']));
                    //});

                    $.each(categories, function (index, category) {
                        addListItem(category.Value, category.Text, category.Selected);
        ...
        $(document).on('change', '#cus_category', function (event) {
            ...
            var selectedValue = $(this).val();
            // Set the selected option based on the value received from the server
            $("#cus_category option[value='" + selectedValue + "']").attr("selected", "selected");//.prop('selected', true);


            var text = document.getElementById('cus_category').selectedValue;
            console.log(text);
        ...
        var dept = document.getElementById('cus_department').Value;
        var dropdownList = document.getElementById('cus_category');

        // Function to add a new ListItem
        function addListItem(value, text, selected) {
        ...
        // Iterate through the server-side array list and add ListItems
        <% For Each item As ListItem In LoadCategories("dept") %>
            addListItem('<%= item.Value %>', '<%= item.Text %>', <%= item.Selected.ToString().ToLower() %>);
        <% Next %>
