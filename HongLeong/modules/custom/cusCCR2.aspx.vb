...
Partial Public Class cusccr2_class
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        _FormsName = "Customer Complaint Report (CCR) - PRODUCT QUALITY"
        ...
        Dim salesCloseValGrp As String() = cus_salesclose.ValidationGroup.Split("-")
        If salesCloseValGrp(0) <> wfb_bar.wlevel.value Then
            cus_salesclose.Enabled = False
        End If
    ...
    Private Function ValidateForm(Optional ByVal pType As String = "")
        ...
        If cus_immediateaction.Enabled = True Then
        ...
        If cus_cusaccept.Enabled = True Then
        ...
        If cus_valid.Enabled = True Then
        ...
        If cus_investigatorremarks.Enabled = True Then
            If (cus_investigatorremarks.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: COMMENTS BY SITE INVESTIGATOR")
                Return False
            End If
        End If

        If cus_salesmanager.Enabled = True Then
            If (cus_salesmanager.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: MANAGER, SALES")
                Return False
            End If
        End If

        If cus_qcfindings.Enabled = True Then
            If (cus_qcfindings.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: QC / LOGISTIC / PRODUCTION / SALES FINDINGS")
                Return False
            End If
        End If

        If cus_corrective.Enabled = True Then
            If (cus_corrective.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: CORRECTIVE / PREVENTIVE ACTION")
                Return False
            End If

            If pType = "Approve" Then
                If cus_rootcause.Checked = True Then
                    Dim checkReport As Boolean = WebLib.CodeExists(WebLib.LoginUser.replace("'", "''"), "doc_createby", "docdoc", "doc_id", "", "doc_uniqueid", "'" & ucode.Value & "'", "", "", "doc_filter", " doc_createdt >= (select top 1 wfa_createon from workflowaudit where wfa_ucode = '" & ucode.Value & "' and wfa_level = " & wfb_bar.wlevel.value - 1 & " order by wfa_id desc) and doc_attach1 <> '' ")
        ...
        If cus_plantmgr.Enabled = True Then
            If (cus_plantmgr.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: PLANT MANAGER")
                Return False
            End If
        End If

        If cus_gmsalesremarks.Enabled = True Then
            If (cus_gmsalesremarks.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: CASE CLOSED BY SENIOR MANAGER, SALES/ MANAGER, SALES")
                Return False
            End If
        End If

        If cus_gmremarks.Enabled = True Then
            If (cus_gmremarks.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: CASE VERIFIED BY GM")
                Return False
            End If
        End If

        If cus_salesclose.Enabled = True Then
            If (cus_salesclose.Text & "").Trim = "" Then
                lblMessage.Text = WebLib.getAlertMessageStyle("Fields Required: CASE CLOSED BY SALES")
                Return False
            End If
            'If lcnstatus.Text <> "Approved" And pType <> "" Then
            '    lblMessage.Text = WebLib.getAlertMessageStyle("CREDIT NOTE MUST BE APPROVED")
            '    Return False
            'End If
        End If
    ...
    Public Overrides Function LoadData() As Boolean
        ...
        Try
            ...
            For Each dr In ds.Tables("datarecords").Rows
                ...
                cus_salesmanager.Text = dr("cus_salesmanager") & ""
                cus_plantmgr.Text = dr("cus_plantmgr") & ""
                cus_salesclose.Text = dr("cus_salesclose") & ""

                cus_hp.Text = dr("cus_hp") & ""

                'templi = cus_cusaccept.Items.FindByValue(dr("cus_cusaccept") & "")
                'cus_cusaccept.SelectedIndex = cus_cusaccept.Items.IndexOf(templi)
                ...
                Try
                    'cus_immediatedate.Text = dr("cus_immediatedate") & ""
                ...
                cus_qcfindings.Text = dr("cus_qcfindings") & ""
                cus_corrective.Text = dr("cus_corrective") & ""
                ...
                '                cus_qcname.Text = dr("cus_qcname") & ""
                cus_gmsalesremarks.Text = dr("cus_gmsalesremarks") & ""
                cus_gmremarks.Text = dr("cus_gmremarks") & ""
    ...
    Private Sub savedatadata(ByVal pWorkflowAction As Boolean, ByVal pType As String)
        ...
        Try
            If rid.Value = "" Then
                ...
                insertfields = insertfields & ",cus_investigatorremarks"
                insertvalues = insertvalues & ",'" & cus_investigatorremarks.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_investigatordate"
                insertvalues = insertvalues & "," & lcusinvestigatordate & ""
                insertfields = insertfields & ",cus_salesmanager"
                insertvalues = insertvalues & ",'" & cus_salesmanager.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_plantmgr"
                insertvalues = insertvalues & ",'" & cus_plantmgr.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_salesclose"
                insertvalues = insertvalues & ",'" & cus_salesclose.Text.Replace("'", "''") & "'"

                insertfields = insertfields & ",cus_qcfindings"
                insertvalues = insertvalues & ",'" & cus_qcfindings.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_corrective"
                insertvalues = insertvalues & ",'" & cus_corrective.Text.Replace("'", "''") & "'"
                ...
                '                insertfields = insertfields & ",cus_qcname"
                '               insertvalues = insertvalues & ",'" & cus_qcname.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_gmsalesremarks"
                insertvalues = insertvalues & ",'" & cus_gmsalesremarks.Text.Replace("'", "''") & "'"
                insertfields = insertfields & ",cus_gmremarks"
                insertvalues = insertvalues & ",'" & cus_gmremarks.Text.Replace("'", "''") & "'"
                ...
                'insertvalues = insertvalues & ",'" & cus_cusaccept.SelectedValue & "'"
                ...
                '                insertfields = insertfields & ",cus_initiateaccept"
                '               insertvalues = insertvalues & ",'" & cus_initiateaccept.SelectedValue & "'"

                '                insertfields = insertfields & ",cus_initiateremarks"
                '               insertvalues = insertvalues & ",'" & cus_initiateremarks.Text.Replace("'", "''") & "'"
            ...
            Else
                ...
                End If
                If cus_investigatorremarks.Enabled = True Then
                    insertvalues = insertvalues & ",cus_investigatorremarks='" & cus_investigatorremarks.Text.Replace("'", "''") & "'"
                End If
                If cus_investigatordate.Enabled = True Then
                    '                    insertvalues = insertvalues & ",cus_investigatordate='" & cus_investigatordate.Text.Replace("'", "''") & "'"
                    insertvalues = insertvalues & ",cus_investigatordate=" & lcusinvestigatordate & ""
                End If
                If cus_salesmanager.Enabled = True Then
                    insertvalues = insertvalues & ",cus_salesmanager='" & cus_salesmanager.Text.Replace("'", "''") & "'"
                End If
                If cus_plantmgr.Enabled = True Then
                    insertvalues = insertvalues & ",cus_plantmgr='" & cus_plantmgr.Text.Replace("'", "''") & "'"
                End If
                If cus_salesclose.Enabled = True Then
                    insertvalues = insertvalues & ",cus_cusaccept='" & cus_cusaccept.Checked & "'"
                    insertvalues = insertvalues & ",cus_salesclose='" & cus_salesclose.Text.Replace("'", "''") & "'"
                End If
                If cus_qcfindings.Enabled = True Then
                    insertvalues = insertvalues & ",cus_qcfindings='" & cus_qcfindings.Text.Replace("'", "''") & "'"
                End If
                If cus_corrective.Enabled = True Then
                    insertvalues = insertvalues & ",cus_corrective='" & cus_corrective.Text.Replace("'", "''") & "'"
                End If
                If cus_valid.Enabled = True Then
                    insertvalues = insertvalues & ",cus_valid='" & cus_valid.SelectedValue & "'"
                End If
                If cus_rootcause.Enabled = True Then
                    insertvalues = insertvalues & ",cus_rootcause=" & IIf(cus_valid.SelectedValue = "Yes", 1, 0) & ""
                End If
                '                If cus_qcname.Enabled = True Then
                'insertvalues = insertvalues & ",cus_qcname='" & cus_qcname.Text.Replace("'", "''") & "'"
                '            End If
                If cus_gmsalesremarks.Enabled = True Then
                    insertvalues = insertvalues & ",cus_gmsalesremarks='" & cus_gmsalesremarks.Text.Replace("'", "''") & "'"
                End If
                If cus_gmremarks.Enabled = True Then
                    insertvalues = insertvalues & ",cus_gmremarks='" & cus_gmremarks.Text.Replace("'", "''") & "'"
                End If
                '                If cus_initiateaccept.Enabled = True Then
                'insertvalues = insertvalues & ",cus_initiateaccept='" & cus_initiateaccept.SelectedValue & "'" & "'"
                '            End If

                '                If cus_initiateremarks.Enabled = True Then
                'insertvalues = insertvalues & ",cus_initiateremarks='" & cus_initiateremarks.Text.Replace("'", "''") & "'"
                '            End If
                If cus_immediatedate.Enabled = True Then
                    '                    insertvalues = insertvalues & ",cus_immediatedate='" & cus_immediatedate.Text.Replace("'", "''") & "'"
                ...
                End If
                'If cus_cusaccept.Enabled = True Then
                '    insertvalues = insertvalues & ",cus_cusaccept='" & cus_cusaccept.SelectedValue & "'"
                'End If
                If cus_immediateaction.Enabled = True Then
