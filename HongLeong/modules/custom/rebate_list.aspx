<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="rebate_list.aspx.vb" Inherits="rebate_list_class" %>
                    ...
                    <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                        <thead>
                            <tr>
                                ...
                                <th class="cssdetail"><b>Subject</b></th>
                                ...
                                <ItemTemplate>
                                    <tr id="trRow" class="ui-widget-content" runat="server">
                                        ...
                                        <td class="cssdetail" style="border-bottom: solid 1px silver">
                                            <asp:Literal ID="litcust" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "cus_company") + If(DataBinder.Eval(Container.DataItem, "wst_refno").ToString() = "", "", "<br/>( Ticket No. " + DataBinder.Eval(Container.DataItem, "wst_refno") + " )")%>'></asp:Literal>
                                        </td>
                                        <td class="cssdetail" style="border-bottom: solid 1px silver">
