...
Partial Public Class dncn_list_class
    Inherits listpage
    'Generated by VI FEANDI SOFTLABS FORM GENERATOR (http://www.vifeandi.net) VER 2014.1
    Private FORMCODE As String = "DNCN"  'Hardcoded for customised form
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        bid.value = "zcustom_dncn"


        Call InitLoad()

        btnback.visible = False
        Redirector.PrevURL1 = "modules/custom/dncn_list.aspx"
        btnadd.Visible = True
