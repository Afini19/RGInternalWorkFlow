<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="crI.aspx.vb" Inherits="crI_class" ValidateRequest="False"%>
                    ...
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-1" hidden="hidden">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_title" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="false" Visible="false">Internal CR</asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_crtype" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="false">Internal CR</asp:TextBox>
                                    </div>
                                </div>
                            </div>
...
<%--                            <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAget().tostring.trim <> "1" And Not backend.closed(uid.Value) then %>--%>
                            ...
                            <%If (lvlvalid.Value = "True" And wfb_bar.wlevelAPget().ToString.Trim = "3") Or wfb_bar.wlevelAPget().ToString.Trim = "4" Or (lvlvalid.Value = "False" And wfb_bar.wlevelAPget().ToString.Trim = "5") Then %>
