<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="cusCCR_listS.aspx.vb" Inherits="cusCCRS_list_class" %>
                        ...
                        <div class="card">
                            ...
                            <div id="opt" class="collapse">
                                <div class="card-body">
                                    ...
                                    <asp:Button ID="btnmy" CssClass="btn btn-info btn-sm w-100" Text="My Action Inbox" runat="server" OnClick="shortcutmy" Style="width: 160px" CausesValidation="false" />
