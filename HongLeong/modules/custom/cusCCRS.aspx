<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="cusccrs.aspx.vb" Inherits="cusccrs_class" %>
                            ...
                            <asp:UpdatePanel runat="server" ID="cnpanel" UpdateMode="Conditional">
                                <ContentTemplate> 
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-md-3">
                                            <asp:Button ID="btnCN" CssClass="btn btn-info btn-sm" Text="Credit Note" runat="server" Visible="false" /></div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            <% End if %>
