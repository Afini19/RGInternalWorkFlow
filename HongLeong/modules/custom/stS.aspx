<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="stS.aspx.vb" Inherits="stS_class" %>
                    ...
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_ticketTitle" runat="server" Style="width: 100%; height: 50px" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_issuetype" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" Enabled="false">Support Issue</asp:TextBox>
                                    </div>
                                </div>
                            </div>
...
<%--                            <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAget().tostring.trim <> "1" And Not backend.closed(uid.Value) then %>--%>
                            ...
                            <%If (lvlvalid.Value = "True" And wfb_bar.wlevelAPget().ToString.Trim = "2") Or wfb_bar.wlevelAPget().ToString.Trim = "3" Or (lvlvalid.Value = "False" And wfb_bar.wlevelAPget().ToString.Trim = "4") Then %>
