...
Partial Public Class inactive_list_class
    Inherits listpage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "Inactive / Close Account"
        'columnscount = "10"
        ...
        End If
        bid.value = "zcustom_inactive"


        Call InitLoad()

        btnback.visible = False
        Redirector.PrevURL1 = "modules/custom/inactive_list.aspx"
        btnadd.Visible = True
