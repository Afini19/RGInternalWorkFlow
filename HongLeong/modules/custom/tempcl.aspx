<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="tempcl.aspx.vb" Inherits="tempcl_class" %>
                    ...
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align:center;"><%=_FormsName%></div>
                                <div class="col-md-3"></div>
                            </div>
                            <div class="row">
                                <div class="col-md-3"></div>
                                <div class="col-md-6" style="text-align:center;">(for urgently needed order only)</div>
                                <div class="col-md-3 " style="text-align: right;">Ref No :&nbsp;<asp:Label ID="lblrefno" runat="server"></asp:Label></div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row mb-1">
                                <div class="col-md-3">Current Credit Limit&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_amt" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">Proposed Temporary Credit Limit&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_amttemp" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-12">Credit Limit Applied for&nbsp;<font class="cssrequired">*</font></div>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_amtapply" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            Credit File in Circulation&nbsp;<font class="cssrequired"></font>:&nbsp;&nbsp;
                                        <asp:CheckBox ValidationGroup="1-" runat="server" ID="cus_creditfile" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-12">Paid-up Capital&nbsp;<font class="cssrequired">*</font></div>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_paidup" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="row">
                                                <div class="col-md-4" style="white-space: nowrap;">Nett Worth<font class="cssrequired">*</font>:</div>
                                                <div class="col-md-8">
                                                    <div class="validation-content" style="position: relative;">
                                                        <asp:TextBox ID="cus_nettworth" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-md-3" style="white-space: nowrap;">As At:</div>
                                                <div class="col-md-9">
                                                    <div class="validation-content" style="position: relative;">
                                                        <uc:datepicker ID="cus_asat" runat="server" AllowNull="false" class="validate[required]" ValidationGroup="1-" Width="100%" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-3">Credit Terms&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_paymentterms" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">Securities&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_cg" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">Corporate Guarantor Name&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-9">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_cgname" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-12">CG Paid Up Capital&nbsp;<font class="cssrequired">*</font></div>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_cgpaidup" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-" />
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="validation-content" style="position: relative;">
                                                        <asp:TextBox ID="cus_cgnettworth" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="validation-content" style="position: relative;">
                                                        <uc:datepicker ID="cus_cgasat" runat="server" AllowNull="false" class="validate[required]" ValidationGroup="1-" Width="100%" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-12">
                                    <b>* TCL only valid for 60 days</b>
                                </div>
                            </div>
