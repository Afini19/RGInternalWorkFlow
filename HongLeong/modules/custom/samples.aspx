<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="samples.aspx.vb" Inherits="samples_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Address&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_address" runat="server" TextMode="MultiLine" Style="width: 100%; height: 100px" MaxLength="500" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_contact" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_contactno" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Distributor&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_distributor" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-6">Distributor salesperson&nbsp;<font class="cssrequired">*</font></div>
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_distributorsales" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_distributorsalescontactno" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Type of Sample&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_typeofsample" runat="server" class="validate[required]" width="100%" ValidationGroup="1-"></asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_qty" runat="server" Style="width: 70%" MaxLength="50" class="validate[required,custom[number]]" ValidationGroup="1-"></asp:TextBox>&nbsp;(kg)
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Nature of Business&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_business" runat="server" class="validate[required]" width="100%" ValidationGroup="1-"></asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Date Sample Needed at Site&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <uc:datepicker ID="cus_duration" runat="server" AllowNull="false" class="validate[required]" ValidationGroup="1-" Width="100%" />
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Mix Design&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_mix" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Type of Trial&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_typeoftest" runat="server" class="validate[required]" width="100%" ValidationGroup="1-"></asp:DropDownList>
                                    </div>
                                </div>
...
<%--                            <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAget().tostring.trim <> "1" And Not backend.closed(ucode.Value) then %>--%>
