<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="cusccrp.aspx.vb" Inherits="cusccrp_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <asp:TextBox ID="cus_remarks" runat="server" class="validate[required]" TextMode="MultiLine" Style="width: 100%; height: 100px" MaxLength="500"></asp:TextBox>
                                </div>
                            </div>
                            <% End if %>
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        <%-- <div class="col-md-6">
                                            <b>CASE ACCEPTED BY CUSTOMER (ATTACH DOC)</b><asp:Label runat="server" ID="lbllevel8"></asp:Label><asp:PlaceHolder ID="phlevel8" runat="server"></asp:PlaceHolder>
                                        </div>--%>
                                        <div class="col-md-6">
