    ...
    Private Function ValidateForm()
        ...
        If cus_devmandays.Enabled = True Then
            If cus_devmandays.Text <> "" Then
                ...
                'If Regex.IsMatch(cus_devmandays.Text, "^(?:0|[1-9]\d*)(?:\.(?:00|25|5|75))?$") = False Or cus_devmandays.Text = "0" Then
                '    lblMessage.Text = WebLib.getAlertMessageStyle("Development man-days: Either an integer greater than 0 or a decimal with exactly two decimal places (0.25, 0.50, 0.75) is allowed")
                '    Return False
                'End If
        ...
        If cus_testingmandays.Enabled = True Then
            If cus_testingmandays.Text <> "" Then
                ...
                'If Regex.IsMatch(cus_testingmandays.Text, "^(?:0|[1-9]\d*)(?:\.(?:00|25|5|75))?$") = False Or cus_testingmandays.Text = "0" Then
                '    lblMessage.Text = WebLib.getAlertMessageStyle("Internal testing man-days: Either an integer greater than 0 or a decimal with exactly two decimal places (0.25, 0.50, 0.75) is allowed")
                '    Return False
                'End If
