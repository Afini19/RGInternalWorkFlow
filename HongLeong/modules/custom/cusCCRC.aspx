<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="cusccrc.aspx.vb" Inherits="cusccrc_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="text-align: right;">Ref No :&nbsp;<asp:Label ID="lblrefno" runat="server"></asp:Label><asp:Label ID="lblrefnoCust" runat="server"></asp:Label></div>
                            </div>
                            <div class="row">
                                <hr width="100%" class="cssdivider" />
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-4">Complaint Type&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_complainttype" runat="server" Style="width: 100%" ValidationGroup="1-" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <% If createdt.Value >= New DateTime(2020, 6, 1, 0, 0, 0) Then %>
                            <div class="row mb-1">
                                <div class="col-md-4">Distributor Contact Name&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_distributorcontname" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="50" class=" validate[required]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-4">Distributor Contact Number&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_distributorcontnum" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="20" CssClass="validate[required,custom[integer]]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-4">Distributor Contact E-mail&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_distributorcontemail" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="50" class="validate[required,custom[email]]" ValidationGroup="1-"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <% End if %>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-6">D/O Number&nbsp;<font class="cssrequired">*</font> 
                                            </div>
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_dono" runat="server" Style="width: 100%;" MaxLength="50" class="validate[required]" ValidationGroup="1-" AutoPostBack="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <% If createdt.Value >= New DateTime(2020, 7, 7, 0, 0, 0) Then %>
                                    <div class="row">
                                        <div class="col-md-6">DO Date&nbsp;<font class="cssrequired">*</font></div>
                                        <div class="col-md-6">
                                            <div class=" validation-content" style="position: relative;">
                                                <uc:datepicker ID="cus_dodate" runat="server" AllowNull="false" width="100%" Enabled="false" /><%-- class="validate[required]" ValidationGroup="1-"--%>
                                            </div>
                                        </div>
                                    </div>
                                    <% End if %>
                            ...
                            <div class="row mb-1" runat="server" id="rwMsgInvalidDO" style="display:none;">
                                <div class="col-md-4"></div>
                                <div class="col-md-8">
                                    <asp:label ID="lblinvaliddo" runat="server" Text="D/O Number Invalid" ForeColor="Red" Style="align-content:flex-end;"></asp:label>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-4">End User Company Name&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_customer" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="50" Enabled="false"></asp:TextBox><%-- class="validate[required]" ValidationGroup="1-"--%>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class=" validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_location" runat="server" Style="width: 100%; font-size: 0.8rem;" TextMode="MultiLine" Enabled="false"></asp:TextBox><%-- class=" validate[required]" ValidationGroup="1-"--%>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_product" runat="server" Style="width: 100%; font-size: 0.8rem;" MaxLength="50" Enabled="false"></asp:TextBox><%-- class="validate[required]" ValidationGroup="1-"--%>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <asp:TextBox ID="cus_qty" runat="server" Style="width: 100%" MaxLength="50" Enabled="false"></asp:TextBox><%-- ValidationGroup="1-"--%>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                        ...
                                        <div class="col-md-8">
                                            <div class="validation-content" style="position: relative;">
                                                <asp:TextBox ID="cus_transporter" runat="server" Style="width: 100%" MaxLength="50" Enabled="false"></asp:TextBox><%-- ValidationGroup="1-"--%>
                                            </div>
                                        </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-4">Site Contact Number&nbsp;<font class="cssrequired"></font></div>
                                        <div class="col-md-8">
                                            <asp:TextBox ID="cus_telno" runat="server" Style="width: 100%" MaxLength="50" ValidationGroup="1-" class="validate[required]"></asp:TextBox><%-- class="validate[required,custom[integer]]"--%>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <% If createdt.Value >= New DateTime(2020, 6, 1, 0, 0, 0) Then %>
                            <div class="row mb-1" runat="server" id="rwAccountHolder">
                            ...
                            <% If backend.viewRights2(wfb_bar.wlevelAget(), 2, rid.Value, IIf(NmSpace = "zcustom_ccrc", "zcustom_ccr", NmSpace)) Or wfb_bar.wlevelAPget().tostring.trim = "2" Then %>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_classification" runat="server" Style="width: 100%" ValidationGroup="2-" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_complaint" runat="server" Style="width: 100%" ValidationGroup="2-"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <%--<% If createdt.Value >= New DateTime(2020, 6, 1, 0, 0, 0) Then %>
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:DropDownList ID="cus_accountholder" runat="server" Style="width: 100%" ValidationGroup="2-" class="validate[required]"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <% End if %>--%>
                            ...
                            <% If lvlvalid.Value = "True" And wfb_bar.wlevelAPget().tostring.trim <> "1" And wfb_bar.wlevelAPget().tostring.trim <> "2" And wfb_bar.wlevelAPget().tostring.trim <> "5" And Not backend.closed(ucode.Value) Then %>
                            <div class="row">
                                <hr width="100%" class="cssdivider" />
                            </div>
                            <div class="row mb-2">
                            ...
                            <%If lvlvalid.Value = "True" And backend.viewRights2(wfb_bar.wlevelAget(), 20, rid.Value, NmSpace) And wfb_bar.wlevelAPget().tostring.trim = "20" Then %>
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    ...
                                    <%If WebLib.isStaff = False And (wfb_bar.wlevelAPget().ToString.Trim = "" Or wfb_bar.wlevelAPget().ToString.Trim = "1") Then %>
                                    <asp:Button ID="SaveSubmitButton" Text="Save & Submit Record" runat="server" OnClick="savesubmitpage" Style="width: 100%" />                                    
                                    <%End if %>
                                    <br />
                                </td>
                            </tr>
