...
Partial Public Class samples_list_class
    Inherits listpage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        pFieldNames = " workflowstatus.*,zcustom_samples.*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") "
        ...
        End If
        bid.value = "zcustom_samples"


        Call InitLoad()

        btnback.visible = False
        Redirector.PrevURL1 = "modules/custom/samples_list.aspx"
        btnadd.Visible = True
