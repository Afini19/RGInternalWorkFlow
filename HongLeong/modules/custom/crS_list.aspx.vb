...
Partial Public Class crS_list_class
    Inherits listpage
    'Generated by VI FEANDI SOFTLABS FORM GENERATOR (http://www.vifeandi.net) VER 2014.1
    Private FORMCODE As String = "CRS"  'Hardcoded for customised form
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "Change Request Form - Support CR"
        'columnscount = "10"
        ...
        ModRights = "" '"SM0002"
        ViewRights = "" '"SM0004"
        FullRights = "CC0005" 'dont know
        NmSpace = "zcustom_crS"


        backend.DeleteOldDraft(TableName)

        pFieldNames = " workflowstatus.*,zcustom_crS.*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") "
        ...
        If Page.IsPostBack = False Then
            ...
            pendinglevel.DataSource = backend.GetLevelList(1046)
        ...
        End If
        bid.Value = "zcustom_crS"

        Call InitLoad()

        btnback.Visible = False
        Redirector.PrevURL1 = "modules/custom/crS_list.aspx"
        btnadd.Visible = True
    ...
    Protected Sub SearchtheData()
        ...
        'theObject = Page.Master.FindControl("ContentArea").FindControl("description")
        theObject = businessReq.Text
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchCR.CR_BusinessReq(theObject)
            End If
        End If
