...
Partial Public Class stI_list_class
    Inherits listpage
    'Generated by VI FEANDI SOFTLABS FORM GENERATOR (http://www.vifeandi.net) VER 2014.1
    Private FORMCODE As String = "STI"  'Hardcoded for customised form
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "Support Ticket - Internal Issue"
        'columnscount = "10"
        ...
        'pFieldNames = " workflowstatus.*,zcustom_stI.*,usr_name,ApprovalLevelName = (" & clsWorkflow.getLevelNameSQL("wst_workflowid", "wst_level") & ") "
        ...
        If Page.IsPostBack = False Then
            ...
            pendinglevel.DataSource = backend.GetLevelList(1047)
        ...
        End If
        bid.Value = "zcustom_stI"

        Call InitLoad()

        btnback.Visible = False
        Redirector.PrevURL1 = "modules/custom/stI_list.aspx"
        btnadd.Visible = True
    ...
    Public Sub AddEventAdd(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        LogtheAudit(Redirector.Redirect(bid.Value, "", True))
    End Sub
    ...
    Protected Sub SearchtheData()
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                ...
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_DocumentNo(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_STNo(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_RequestTitle(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Department(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Category(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Module(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Customer(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Priority(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_TechnicalReq(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Tags(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_Status(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_PendingLevel(theObject)
            End If
        End If
        ...
        If theObject IsNot Nothing Then
            If (theObject & "").Trim <> "" Then
                If (lFilterStatement & "").Trim <> "" Then
                    lFilterStatement = lFilterStatement & " and "
                End If
                lFilterStatement = lFilterStatement & WebSearchST.ST_PendingPerson(theObject, clsWorkflow.getUserCodebyWorkFlowSQL("wst_workflowid", "wst_level"))
            End If
        End If
        ...
        Else
            ...
            If (lFilterStatement & "").Trim <> "" Then
                lFilterStatement = lFilterStatement & " and "
            End If
            lFilterStatement = lFilterStatement & "(" & WebSearchST.ST_CreateDate(lfromdate, 0, ">=") & " and " & WebSearchST.ST_CreateDate(ltodate, 0, "<=") & ")"
