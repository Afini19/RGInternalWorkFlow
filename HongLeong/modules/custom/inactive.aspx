<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="inactive.aspx.vb" Inherits="inactive_class" %>
                ...
                <div class="row listpage">
                    <div class="col-md-8 bg-light " style="font-size: 0.8rem;">
                        <div runat="server" id="mp">
                            ...
                            <div class="row">
                                <div class="col-md-4">&nbsp;<font class="cssrequired"></font></div>
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phlevel2" runat="server"></asp:PlaceHolder>
                                </div>
                            </div>

                            <div class="row mb-1">
                                <div class="col-md-4">Reasons&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_reasons" runat="server" TextMode="MultiLine" Style="width: 100%; height: 100px" MaxLength="500" class="validate[required]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Account Open Since&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_acctsince" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Past Sales Volume / month(MT)&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-8">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_sales" runat="server" Style="width: 100%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </div>
                            </div>

                            <div class="row mb-1">
                                <div class="col-md-4">Outstanding Balance&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-4">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cus_outbal" runat="server" Style="width: 100%" MaxLength="50" class="validate[required,custom[number]]"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-6">As At:</div>
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <uc:datepicker ID="cus_asat" runat="server" AllowNull="false" class="validate[required]" Width="100%" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-4">Dispute (Diversion,RMA)&nbsp;<font class="cssrequired">*</font></div>
                                <div class="col-md-4">
                                    <asp:TextBox ID="cus_dispute" runat="server" class="validate[required]" Style="width: 100%" MaxLength="50" />
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-6">As At:</div>
                                        <div class="col-md-6">
                                            <div class="validation-content" style="position: relative;">
                                                <uc:datepicker ID="cus_disputeasat" runat="server" AllowNull="false" class="validate[required]" Width="100%" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <%-- <% If lvlvalid.Value = "True" And wfb_bar.wlevelAget().tostring.trim <> "" And wfb_bar.wlevelAget().tostring.trim <> "1" And wfb_bar.wlevelAget().tostring.trim <> "2" And Not backend.closed(ucode.Value) then %>--%>
