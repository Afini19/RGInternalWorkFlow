...
Partial Public Class crC_list_class
    Inherits listpage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        listingpage = ""
        _FormsName = "Change Request Form - Customer CR"
        'columnscount = "10"
        ...
        If Page.IsPostBack = False Then
            ...
            pendinglevel.DataSource = backend.GetLevelList(45)
        ...
        bid.Value = "zcustom_crC"

        Call InitLoad()

        btnback.Visible = False
        Redirector.PrevURL1 = "modules/custom/crC_list.aspx"
        btnadd.Visible = True
