...
Partial Public Class cn3_class
    ...
    Private Sub savedatadata(ByVal pWorkflowAction As Boolean, ByVal pType As String)
        ...
        Try
            If rid.Value = "" Then
                ...
                insertfields = insertfields & ",cus_ccrno"
                insertvalues = insertvalues & ",'" & lblccrno.Text.Replace("'", "''") & "'"
                ...
                insertvalues = insertvalues & "," & cus_cndnamt.Text.Replace("'", "''").Replace(",", "") & ""
            ...
            Else
                ...
                insertvalues = insertvalues & ",cus_cndnamt=" & cus_cndnamt.Text.Replace("'", "''").Replace(",", "") & ""
                'End If
