...
Partial Public Class cusccrc_class
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        FORMCODE = IIf((Request("wp5") & "").ToUpper <> "", (Request("wp5") & "").ToUpper, (Request("events") & "").ToUpper)
        ...
        If FORMCODE = "" Then
            FORMCODE = cus_complainttype.SelectedValue
        End If

        If FORMCODE = "CCR" Then
            _FormsName = _FormsName & " - PRODUCT QUALITY"
            FullRights = "PQ0005"
        ElseIf FORMCODE = "CCRP" Then
            _FormsName = _FormsName & " - Packaging"
            FullRights = "PK0005"
        ElseIf FORMCODE = "CCRS" Then
            _FormsName = _FormsName & " - Service"
            FullRights = "PS0005"
        End If
        NmSpace = "zcustom_" & FORMCODE.ToLower
        ...
        If Page.IsPostBack = False Then
            ...
            cus_complainttype.SelectedValue = FORMCODE
    ...
    Public Overrides Function LoadData() As Boolean
        ...
        Try
            ...
            For Each dr In ds.Tables("datarecords").Rows
                ...
                If dr("cus_createdt").ToString.Trim >= New DateTime(2020, 7, 7, 0, 0, 0) Then
                    cus_dateofcomplaint.Enabled = False
                End If
        ...
        Try
            ...
            Else
                ...
                If wfb_bar.wlevelAPget().tostring.trim = "2" Then
                    ...
                    '    lsql = lsql & " update workflowstatus set wst_workflowid='" & wID & "',wst_module='" & NmSpace & "',wst_param2='" & lDocno & "',wst_param3='" & cus_refno.Text & "' where wst_ucode ='" & ucode.Value & "' "
                    'End If
            ...
            If pWorkflowAction Then
                Select Case wfb_bar.wlevelAPget().tostring.trim
                    Case "2"
                        ...
                        'End If
                        If cus_remarks.Text.ToString.PadRight(25).Contains("( Visit On - ") = True Then
                            cus_remarks.Text = cus_remarks.Text.Remove(cus_remarks.Text.Trim.Length - 25, 25)
                        End If
                        lsqlcom = lsqlcom & ",'" & cus_remarks.Text.Replace("'", "''") & IIf(cus_investigatordate.Value = "", "'", " ( Visit On - " & WebLib.formatthedate(cus_investigatordate.DateValue) & " )'")
                    ...
                    Case "3"
                        ...
                        'End If
                        'If cus_remarks.Text.Length < 10 Then

                        'ElseIf cus_remarks.Text.Substring(0, 10).Contains("Invalid") = True Then
                        'Else
                        If cus_remarks.Text.ToString.PadLeft(10).Contains("Invalid") = True Then
                                cus_remarks.Text = cus_remarks.Text.Replace("Invalid - ", "")
                                'ElseIf cus_remarks.Text.Substring(0, 10).Contains("Valid") = True Then
                            ElseIf cus_remarks.Text.PadLeft(10).Contains("Valid") = True Then
                                cus_remarks.Text = cus_remarks.Text.Replace("Valid - ", "")
                        End If
                        lsqlcom = lsqlcom & ",'" & IIf(cus_valid.SelectedValue = "Yes", "Valid", "Invalid") & " - " & cus_remarks.Text.Replace("'", "''") & "'"

                    Case "4"
                        If cus_remarks.Text.Contains(" (Root Cause Analysis attachment is mandatory for Valid case)") = True Then
                            cus_remarks.Text = cus_remarks.Text.Replace("(Root Cause Analysis attachment is mandatory for Valid case)", "")
                        End If
                        lsqlcom = lsqlcom & ", '" & cus_remarks.Text.Replace("'", "''")
                        If cus_rootcause.Checked = True Then
                    ...
                    Case "5"
                        ...
                        End If
                    Case "6"
                        If cus_remarks.Text.ToString.PadLeft(29).Contains("Case not accepted by Customer") = True Then
                            cus_remarks.Text = cus_remarks.Text.Replace("Case not accepted by Customer - ", "")
                        ElseIf cus_remarks.Text.PadLeft(29).Contains("Case accepted by Customer") = True Then
                            cus_remarks.Text = cus_remarks.Text.Replace("Case accepted by Customer - ", "")
                        End If
            ...
            If savedata(insertfields, insertvalues, True, lsql) = True Then
                ...
                If lblrefnoCust.Text <> "" And cus_distributorcontemail.Text.Trim <> "" And WebLib.GetValue("workflowstatus", "wst_status", "wst_ucode", "'" & ucode.Value & "'", "", "") <> "Pending" Then ' workflow end
                    If wfb_bar.notifyusers("close", "Y", cus_distributorcontemail.Text) = False Then
                    End If
                End If

                Response.Redirect("~/" & Redirector.Redirect(NmSpace, ucode.Value, False, FORMCODE))
            Else
    ...
    Public Sub loadpr()
        Try
            If lblrefno.Text <> "" And lblrefnoCust.Text <> "" Then
                rep_comment.DataSource = wfb_bar.getCommentsMul()
            Else
                rep_comment.DataSource = wfb_bar.getComments2()
            End If
            rep_comment.DataBind()
            If lblrefno.Text <> "" And lblrefnoCust.Text <> "" Then
                rep_audit.DataSource = wfb_bar.GetAuditLogsDsMul()
            Else
    ...
    Private Sub ShowCNDetail()
        ...
        Try
            cmd.CommandText = "select cus_id, cus_ucode, cus_uno, DateName(month, DateAdd(month, CAST(cus_cndnmth as int) , -1 ))  + ' ' + CAST(cus_cndnyear as nvarchar) as cndate, " &
                                        ...
                                        "where cus_ccrno = '" & IIf(lblrefno.Text = "", "0", lblrefno.Text) & "' " &
