<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="customer.aspx.vb" Inherits="customer_class" %>
                            ...
                            <tr>
                                ...
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_code" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Name&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_name" runat="server" Style="width: 80%" MaxLength="20" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Attention&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_attention" runat="server" Style="width: 80%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="cssdetail" valign="top" align="left">Email&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_email" runat="server" Style="width: 80%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                                                        <tr>
                                <td class="cssdetail" valign="top" align="left">Phone no&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_telno" runat="server" Style="width: 80%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                                                        <tr>
                                <td class="cssdetail" valign="top" align="left">Fax no&nbsp;<font class="cssrequired">*</font></td>
                                <td colspan="1" class="cssdetail" valign="top" align="left">
                                    <div class="validation-content" style="position: relative;">
                                        <asp:TextBox ID="cu_faxno" runat="server" Style="width: 80%" MaxLength="50" class="validate[required]"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                        </table>
