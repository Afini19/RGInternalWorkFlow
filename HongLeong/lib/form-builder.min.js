...
!function (e) {
    ...
    !function (e) {
        ...
        function o(e) {
            ...
            return P;
        }), window.fbLoaded = { js: [], css: [] }, window.fbEditors = { quill: {}, tinymce: {} };var l = function l(e) {
            var t = [null, void 0, ""];for (var r in e) {
                t.includes(e[r]) ? delete e[r] : Array.isArray(e[r]) && (e[r].length || delete e[r]);
            }return e;
        },
            s = function s(e) {
            return !["values", "enableOther", "others", "label", "subtype"].includes(e);
        },
            u = function u(e) {
            ...
            return Object.entries(e).map(function (e) {
                var t = e[0],
                    r = e[1];return s(t) && Object.values(c(t, r)).join("");
            }).filter(Boolean).join(" ");
        },
            c = function c(e, t) {
            var r;return e = p(e), t && (Array.isArray(t) ? r = k(t.join(" ")) : ("boolean" == typeof t && (t = t.toString()), r = k(t.trim()))), { name: e, value: t = t ? '="' + r + '"' : "" };
        },
            d = function e(t) {
            ...
            h = function h(e) {
            var t = new Date().getTime();return (e.type || m(e.label)) + "-" + t;
        },
            g = function g(e) {
            return void 0 === e ? e : [["array", function (e) {
                ...
                return e && e.dom;
            }], [typeof e === "undefined" ? "undefined" : _typeof(e), function () {
                return !0;
            }]].find(function (t) {
                return t[1](e);
            })[0];
            ...
            v = function e(t, r, n) {
            void 0 === r && (r = ""), void 0 === n && (n = {});var o = g(r),
                i = n,
                l = i.events,
                s = a(i, ["events"]),
                u = document.createElement(t),
                f = { string: function string(e) {
                    u.innerHTML += e;
                }, object: function object(t) {
                    var r = t.tag,
                        n = t.content,
                        o = a(t, ["tag", "content"]);return u.appendChild(e(r, n, o));
                    ...
                    e = e(), o = g(e), f[o](e);
                }, undefined: function undefined() {} };for (var c in s) {
                if (s.hasOwnProperty(c)) {
                    var d = p(c),
                        m = Array.isArray(s[c]) ? q(s[c].join(" ").split(" ")).join(" ") : s[c];u.setAttribute(d, m);
                }
            }return r && f[o](r), function (e, t) {
                if (t) {
                    var r = function r(_r) {
            ...
            y = function y(e) {
            var t = e.attributes,
                r = {};return j(t, function (e) {
                var n = t[e].value || "";n.match(/false|true/g) ? n = "true" === n : n.match(/undefined/g) && (n = void 0), n && (r[b(t[e].name)] = n);
            }), r;
        },
            w = function w(e) {
            for (var t = [], r = 0; r < e.length; r++) {
                var n = o({}, y(e[r]), { label: e[r].textContent });t.push(n);
            }return t;
        },
            x = function x(e) {
            var t = new window.DOMParser().parseFromString(e, "text/xml"),
                r = [];if (t) for (var n = t.getElementsByTagName("field"), o = 0; o < n.length; o++) {
                var i = y(n[o]),
                    a = n[o].getElementsByTagName("option");a && a.length && (i.values = w(a)), r.push(i);
            }return r;
        },
            A = function A(e) {
            var t = document.createElement("textarea");return t.innerHTML = e, t.textContent;
        },
            O = function O(e) {
            var t = document.createElement("textarea");return t.textContent = e, t.innerHTML;
        },
            k = function k(e) {
            var t = { '"': "&quot;", "&": "&amp;", "<": "&lt;", ">": "&gt;" };return "string" == typeof e ? e.replace(/["&<>]/g, function (e) {
                return t[e] || e;
            }) : e;
        },
            j = function j(e, t, r) {
            ...
            var r,
                n = jQuery,
                o = [];return Array.isArray(e) || (e = [e]), L(e) || (o = jQuery.map(e, function (e) {
                var r = { dataType: "script", cache: !0, url: (t || "") + e };return jQuery.ajax(r).done(function () {
            ...
            L = function L(e, t) {
            void 0 === t && (t = "js");var r = !1,
                n = window.fbLoaded[t];return r = Array.isArray(e) ? e.every(function (e) {
                return n.includes(e);
            }) : n.includes(e), r;
        },
            N = function N(t, r) {
            Array.isArray(t) || (t = [t]), t.forEach(function (t) {
                var n = "href",
                    o = t,
                    i = "";if ("object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && (n = t.type || (t.style ? "inline" : "href"), i = t.id, t = "inline" == n ? t.style : t.href, o = i || t.href || t.style), !L(o, "css")) {
                    if ("href" == n) {
                        var a = document.createElement("link");a.type = "text/css", a.rel = "stylesheet", a.href = (r || "") + t, document.head.appendChild(a);
                    } else e('<style type="text/css">' + t + "</style>").attr("id", i).appendTo(e(document.head));window.fbLoaded.css.push(o);
                }
            });
        },
            S = function S(e) {
            ...
            var t = (e = Array.isArray(e) ? e : [e]).map(function (e) {
                var t = e.src,
                    r = e.id;return new Promise(function (e) {
                    if (window.fbLoaded.css.includes(t)) return e(t);var n = v("link", null, { href: t, rel: "stylesheet", id: r });document.head.insertBefore(n, document.head.firstChild);
                });
            });return Promise.all(t);
        },
            z = function z(e) {
            var t = document.getElementById(e);return t.parentElement.removeChild(t);
        };function P(e) {
            var t = ["a", "an", "and", "as", "at", "but", "by", "for", "for", "from", "in", "into", "near", "nor", "of", "on", "onto", "or", "the", "to", "with"].map(function (e) {
                return "\\s" + e + "\\s";
            }),
                r = new RegExp("(?!" + t.join("|") + ")\\w\\S*", "g");return ("" + e).replace(r, function (e) {
                return e.charAt(0).toUpperCase() + e.substr(1).replace(/[A-Z]/g, function (e) {
                    return " " + e;
                });
            });
        }var U = { addEventListeners: T, attrString: f, camelCase: b, capitalize: S, closest: D, getContentType: g, escapeAttr: k, escapeAttrs: function escapeAttrs(e) {
                for (var t in e) {
                    e.hasOwnProperty(t) && (e[t] = k(e[t]));
                }return e;
            }, escapeHtml: O, forceNumber: F, forEach: j, getScripts: E, getStyles: N, hyphenCase: m, isCached: L, markup: v, merge: function e(t, r) {
                var n = Object.assign({}, t, r);for (var o in r) {
                    n.hasOwnProperty(o) && (Array.isArray(r[o]) ? n[o] = Array.isArray(t[o]) ? q(t[o].concat(r[o])) : r[o] : "object" == _typeof(r[o]) ? n[o] = e(t[o], r[o]) : n[o] = r[o]);
                }return n;
            }, mobileClass: B, nameAttr: h, parseAttrs: y, parsedHtml: A, parseOptions: w, parseXML: x, removeFromArray: C, safeAttr: c, safeAttrName: p, safename: R, subtract: M, trimObj: l, unique: q, validAttr: s, titleCase: P, splitObject: function splitObject(e, t) {
                var r = function r(e) {
                    return function (t, r) {
                        return t[r] = e[r], t;
                    };
        ...
        r.d(t, "a", function () {
            ...
            o = r(2),
            i = r.n(o);function a(e, t) {
            for (var r = 0; r < t.length; r++) {
                var n = t[r];n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, n.key, n);
            }
        }var l = function () {
            function e(t, r) {
                this.rawConfig = jQuery.extend({}, t), t = jQuery.extend({}, t), this.preview = r, delete t.isPreview, this.preview && delete t.required;for (var n = 0, o = ["label", "description", "subtype", "required", "disabled"]; n < o.length; n++) {
                    var i = o[n];this[i] = t[i], delete t[i];
                }t.id || (t.name ? t.id = t.name : t.id = "control-" + Math.floor(1e7 * Math.random() + 1)), this.id = t.id, this.type = t.type, this.description && (t.title = this.description), e.controlConfig || (e.controlConfig = {});var a = this.subtype ? this.type + "." + this.subtype : this.type;this.classConfig = jQuery.extend({}, e.controlConfig[a] || {}), this.subtype && (t.type = this.subtype), this.required && (t.required = "required", t["aria-required"] = "true"), this.disabled && (t.disabled = "disabled"), this.config = t, this.configure();
            }e.register = function (t, r, n) {
                var o = n ? n + "." : "";e.classRegister || (e.classRegister = {}), Array.isArray(t) || (t = [t]);var i = t,
                    a = Array.isArray(i),
                    l = 0;for (i = a ? i : i[Symbol.iterator]();;) {
                    var s;if (a) {
                        if (l >= i.length) break;s = i[l++];
                    } else {
                        if ((l = i.next()).done) break;s = l.value;
                ...
                void 0 === t && (t = !1);var r = Object.keys(e.classRegister);return r.length ? r.filter(function (e) {
                    return t ? e.indexOf(t + ".") > -1 : -1 == e.indexOf(".");
                }) : r;
            }, e.getRegisteredSubtypes = function () {
                var t = {};for (var r in e.classRegister) {
                    if (e.classRegister.hasOwnProperty(r)) {
                        var n = r.split("."),
                            o = n[0],
                            i = n[1];if (!i) continue;t[o] || (t[o] = []), t[o].push(i);
                    }
                }return t;
            }, e.getClass = function (t, r) {
                var n = r ? t + "." + r : t,
                    o = e.classRegister[n] || e.classRegister[t];return o || e.error("Invalid control type. (Type: " + t + ", Subtype: " + r + "). Please ensure you have registered it, and imported it correctly.");
            }, e.loadCustom = function (t) {
                var r = [];if (t && (r = r.concat(t)), window.fbControls && (r = r.concat(window.fbControls)), !this.fbControlsLoaded) {
                    var n = r,
                        o = Array.isArray(n),
                        i = 0;for (n = o ? n : n[Symbol.iterator]();;) {
                        var a;if (o) {
                            if (i >= n.length) break;a = n[i++];
                        } else {
                            if ((i = n.next()).done) break;a = i.value;
                        }a(e, e.classRegister);
                    }this.fbControlsLoaded = !0;
                }
            }, e.mi18n = function (e, t) {
                var r = this.definition,
                    n = r.i18n || {};n = n[i.a.locale] || n.default || n;var o = this.camelCase(e),
                    a = "object" == (typeof n === "undefined" ? "undefined" : _typeof(n)) ? n[o] || n[e] : n;if (a) return a;var l = r.mi18n;return "object" == (typeof l === "undefined" ? "undefined" : _typeof(l)) && (l = l[o] || l[e]), l || (l = o), i.a.get(l, t);
            }, e.active = function (e) {
                return !Array.isArray(this.definition.inactive) || -1 == this.definition.inactive.indexOf(e);
            }, e.label = function (e) {
                return this.mi18n(e);
            }, e.icon = function (e) {
                var t = this.definition;return t && "object" == _typeof(t.icon) ? t.icon[e] : t.icon;
            };var t,
                r,
                o,
                l = e.prototype;return l.configure = function () {}, l.build = function () {
                var e = this.config,
                    t = e.label,
                    r = e.type,
                    o = function (e, t) {
                ...
                }(e, ["label", "type"]);return this.markup(r, Object(n.t)(t), o);
            }, l.on = function (e) {
                var t = this,
                    r = { prerender: function prerender(e) {
                        return e;
                ...
                return Object(n.c)(e);
            }, t = e, o = [{ key: "definition", get: function get() {
                    return {};
        ...
        e.exports = function (e) {
            ...
            var n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
                ...
                o = r(2),
                i = r(10),
                a = Object.prototype.toString;function l(e) {
            ...
            }e.exports = { isArray: l, isArrayBuffer: function isArrayBuffer(e) {
            ...
            (function (t) {
                var n = r(0),
                    ...
                    !n.isUndefined(e) && n.isUndefined(e["Content-Type"]) && (e["Content-Type"] = t);
                        ...
                        var e;return "undefined" != typeof XMLHttpRequest ? e = r(3) : void 0 !== t && (e = r(3)), e;
            ...
            var n = r(0),
                ...
                l = r(18),
                s = r(4),
                u = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || r(19);e.exports = function (e) {
                return new Promise(function (t, f) {
                    var c = e.data,
                        d = e.headers;n.isFormData(c) && delete d["Content-Type"];var p = new XMLHttpRequest(),
                        m = "onreadystatechange",
                        b = !1;if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in p || l(e.url) || (p = new window.XDomainRequest(), m = "onload", b = !0, p.onprogress = function () {}, p.ontimeout = function () {}), e.auth) {
                        var h = e.auth.username || "",
                            g = e.auth.password || "";d.Authorization = "Basic " + u(h + ":" + g);
                        ...
                        var v = r(20),
                            y = (e.withCredentials || l(e.url)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : void 0;y && (d[e.xsrfHeaderName] = y);
            ...
            var n = r(15);e.exports = function (e, t, r, o, i) {
            ...
            t.__esModule = !0, t.I18N = void 0;var n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
                return typeof e === "undefined" ? "undefined" : _typeof(e);
            } : function (e) {
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e === "undefined" ? "undefined" : _typeof(e);
            },
                ...
                l = t.I18N = function () {
                function e() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a;!function (e, t) {
                    ...
                    var t = this,
                        ...
                        i = n.replace(/\/?$/, "/");this.config = Object.assign({}, { location: i }, o);var l = this.config,
                        s = l.override,
                        u = l.preloaded,
                        f = void 0 === u ? {} : u,
                        c = Object.entries(this.langs).concat(Object.entries(s || f));this.langs = c.reduce(function (e, r) {
                        var n = r[0],
                            o = r[1];return e[n] = t.applyLanguage.call(t, n, o), e;
                    ...
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};t = "string" == typeof t ? this.processFile.call(this, t) : t, this.applyLanguage.call(this, e, t), this.config.langs.push("locale");
                }, e.prototype.getValue = function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.locale;return this.langs[t] && this.langs[t][e] || this.getFallbackValue(e);
                }, e.prototype.getFallbackValue = function (e) {
                    var t = Object.values(this.langs).find(function (t) {
                        return t[e];
                    });return t && t[e];
                }, e.prototype.makeSafe = function (e) {
                    var t = { "{": "\\{", "}": "\\}", "|": "\\|" };return e = e.replace(/\{|\}|\|/g, function (e) {
                        return t[e];
                    }), new RegExp(e, "g");
                }, e.prototype.put = function (e, t) {
                    return this.current[e] = t;
                }, e.prototype.get = function (e, t) {
                    var r = this.getValue(e);if (r) {
                        var o = r.match(/\{[^}]+?\}/g),
                            i = void 0;if (t && o) if ("object" === (void 0 === t ? "undefined" : n(t))) for (var a = 0; a < o.length; a++) {
                            i = o[a].substring(1, o[a].length - 1), r = r.replace(this.makeSafe(o[a]), t[i] || "");
                        } else r = r.replace(/\{[^}]+?\}/g, t);return r;
                    }
                    ...
                    var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                        r = this;return new Promise(function (n, o) {
                        if (-1 !== r.loaded.indexOf(e) && t) return r.applyLanguage.call(r, r.langs[e]), n(r.langs[e]);var a = [r.config.location, e, r.config.extension].join("");return (0, i.get)(a).then(function (t) {
                            var o = t.data,
                                i = r.processFile(o);return r.applyLanguage.call(r, e, i), r.loaded.push(e), n(r.langs[e]);
                        }).catch(function () {
                            var t = r.applyLanguage.call(r, e);n(t);
                        });
                    });
                }, e.prototype.applyLanguage = function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        r = this.config.override[e] || {},
                        n = this.langs[e] || {};return this.langs[e] = Object.assign({}, n, t, r), this.langs[e];
                }, e.prototype.setCurrent = function () {
                    var e = this,
                        t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "en-US";return this.loadLang(t).then(function () {
                        return e.locale = t, e.current = e.langs[t], e.current;
                    });
                }, o(e, [{ key: "getLangs", get: function get() {
            ...
            }var s = l(a);s.Axios = i, s.create = function (e) {
            ...
            var n,
                ...
                if (n === setTimeout) return setTimeout(e, 0);if ((n === a || !n) && setTimeout) return n = setTimeout, setTimeout(e, 0);
                try {
                    return n(e, 0);
                } catch (t) {
                    try {
            ...
            var u,
                ...
                if (!c) {
                    ...
                    for (var t = f.length; t;) {
                        ...
                        if ((o === l || !o) && clearTimeout) return o = clearTimeout, clearTimeout(e);try {
                            o(e);
                        } catch (t) {
                            try {
            ...
            var n = r(4);e.exports = function (e, t, r) {
            ...
            var n = r(0);e.exports = n.isStandardBrowserEnv() ? { write: function write(e, t, r, o, i, a) {
                    var l = [];l.push(e + "=" + encodeURIComponent(t)), n.isNumber(r) && l.push("expires=" + new Date(r).toGMTString()), n.isString(o) && l.push("path=" + o), n.isString(i) && l.push("domain=" + i), !0 === a && l.push("secure"), document.cookie = l.join("; ");
        ...
        var n = r(2),
            ...
            NATIVE_NAME: "English (US)", ENGLISH_NAME: "English", addOption: "Add Option +", allFieldsRemoved: "All fields were removed.", allowMultipleFiles: "Allow users to upload multiple files",
            autocomplete: "Autocomplete", button: "Button", cannotBeEmpty: "This field cannot be empty", checkboxGroup: "Checkbox Group", checkbox: "Checkbox", checkboxes: "Checkboxes",
            className: "Class", clearAllMessage: "Are you sure you want to clear all fields?", clear: "Clear", close: "Close", content: "Content", copy: "Copy To Clipboard", copyButton: "&#43;",
            copyButtonTooltip: "Copy", dateField: "Date Field", description: "Help Text", descriptionField: "Description", devMode: "Developer Mode", editNames: "Edit Names", editorTitle: "Form Elements",
            editXML: "Edit XML", enableOther: "Enable &quot;Other&quot;", enableOtherMsg: "Let users to enter an unlisted option", fieldDeleteWarning: "false", fieldVars: "Field Variables",
            fieldNonEditable: "This field cannot be edited.", fieldRemoveWarning: "Are you sure you want to remove this field?", fileUpload: "File Upload",
            formUpdated: "Form Updated", getStarted: "Drag a field from the right to this area", header: "Header", hide: "Edit", hidden: "Hidden Input", inline: "Inline",
            inlineDesc: "Display {type} inline", label: "Label", labelEmpty: "Field Label cannot be empty", limitRole: "Limit access to one or more of the following roles:", mandatory: "Mandatory",
            maxlength: "Max Length", minOptionMessage: "This field requires a minimum of 2 options", minSelectionRequired: "Minimum {min} selections required", multipleFiles: "Multiple Files",
            name: "Name", no: "No", noFieldsToClear: "There are no fields to clear", number: "Number", off: "Off", on: "On", option: "Option", optionCount: "Option {count}", options: "Options",
            optional: "optional", optionLabelPlaceholder: "Label", optionValuePlaceholder: "Value", optionEmpty: "Option value required", others: "Others", paragraph: "Paragraph", placeholder: "Placeholder", "placeholders.value": "Value", "placeholders.label": "Label",
            "placeholders.email": "Enter you email", "placeholders.className": "space separated classes", "placeholders.password": "Enter your password", preview: "Preview", radioGroup: "Radio Group", radio: "Radio", removeMessage: "Remove Element", removeOption: "Remove Option", remove: "&#215;", required: "Required", requireValidOption: "Only accept a pre-defined Option", richText: "Rich Text Editor", roles: "Access", rows: "Rows", save: "Save", selectOptions: "Options", select: "Select", selectColor: "Select Color", selectionsMessage: "Allow Multiple Selections", size: "Size", "size.xs": "Extra Small", "size.sm": "Small", "size.m": "Default", "size.lg": "Large", style: "Style", "styles.btn.default": "Default", "styles.btn.danger": "Danger", "styles.btn.info": "Info", "styles.btn.primary": "Primary", "styles.btn.success": "Success", "styles.btn.warning": "Warning", subtype: "Type", text: "Text Field", textArea: "Text Area", toggle: "Toggle", warning: "Warning!", value: "Value", viewJSON: "[{&hellip;}]", viewXML: "&lt;/&gt;", yes: "Yes"
        });
        var i = {
            actionButtons: [], allowStageSort: !0, append: !1, controlOrder: ["autocomplete", "button", "checkbox-group", "checkbox", "date", "file", "header", "hidden", "number", "paragraph", "radio-group", "select", "text", "textarea"], controlPosition: "right", dataType: "json", defaultFields: [], disabledActionButtons: [], disabledAttrs: [],
            disabledFieldButtons: {}, disabledSubtypes: {}, disableFields: [], disableHTMLLabels: !1, disableInjectedStyle: !1, editOnAdd: !1, fields: [], fieldRemoveWarn: !1,
            fieldEditContainer: null, inputSets: [], notify: { error: console.error, success: console.log, warning: console.warn }, onAddField: function onAddField(e, t) {
                return t;
            },
            onClearAll: o, onCloseFieldEdit: o, onOpenFieldEdit: o, onSave: o, prepend: !1, replaceFields: [], roles: { 1: "Administrator" }, scrollToFieldOnAdd: !0, showActionButtons: !0, sortableControls: !1, stickyControls: { enable: !0, offset: { top: 5, bottom: "auto", right: "auto" } }, subtypes: {}, templates: {}, typeUserAttrs: {}, typeUserDisabledAttrs: {}, typeUserEvents: {}
        },
        ...
        var n = {},
            o = {
            text: ["text", "password", "email", "color", "tel"], header: ["h1", "h2", "h3"], button: ["button", "submit", "reset"],
            paragraph: ["p", "address", "blockquote", "canvas", "output"], textarea: ["textarea", "quill"]
        },
            i = function i(e) {
            ...
            function e(e) {
                ...
                var r = this;e.parentElement ? t(e) : window.requestAnimationFrame(function () {
        ...
        function n(e) {
            var t;return "function" == typeof Event ? t = new Event(e) : (t = document.createEvent("Event")).initEvent(e, !0, !0), t;
        }var o = { loaded: n("loaded"), viewData: n("viewData"), userDeclined: n("userDeclined"), modalClosed: n("modalClosed"), modalOpened: n("modalOpened"), formSaved: n("formSaved"), fieldAdded: n("fieldAdded"), fieldRemoved: n("fieldRemoved"), fieldRendered: n("fieldRendered"), fieldEditOpened: n("fieldEditOpened"), fieldEditClosed: n("fieldEditClosed") };t.a = o;
    }, function (e, t, r) {
        r.d(t, "a", function () {
            return l;
        });var n = r(1),
            ...
            var t, r, o, l, s;function u() {
                return e.apply(this, arguments) || this;
            }return r = e, (t = u).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, u.register = function (e, t) {
                void 0 === e && (e = {}), void 0 === t && (t = []), u.customRegister = {}, u.def || (u.def = { icon: {}, i18n: {} }), u.templates = e;var r = i.a.locale;u.def.i18n[r] || (u.def.i18n[r] = {}), n.a.register(Object.keys(e), u);var o = t,
                    a = Array.isArray(o),
                    l = 0;for (o = a ? o : o[Symbol.iterator]();;) {
                    var s;if (a) {
                        if (l >= o.length) break;s = o[l++];
                    } else {
                        if ((l = o.next()).done) break;s = l.value;
                    }var f = s,
                        c = f.type;if (f.attrs = f.attrs || {}, !c) {
                        if (!f.attrs.type) {
                            this.error("Ignoring invalid custom field definition. Please specify a type property.");continue;
                        }c = f.attrs.type;
                    }var d = f.subtype || c;if (!e[c]) {
                        var p = n.a.getClass(c, f.subtype);if (!p) {
                            this.error("Error while registering custom field: " + c + (f.subtype ? ":" + f.subtype : "") + ". Unable to find any existing defined control or template for rendering.");continue;
                ...
                var e = u.templates[this.type];if (!e) return this.error("Invalid custom control type. Please ensure you have registered it correctly as a template option.");for (var t = Object.assign(this.config), r = 0, n = ["label", "description", "subtype", "id", "isPreview", "required", "title", "aria-required", "type"]; r < n.length; r++) {
                    var o = n[r];t[o] = this.config[o] || this[o];
                }return (e = (e = e.bind(this))(t)).js && (this.js = e.js), e.css && (this.css = e.css), this.onRender = e.onRender, { field: e.field, layout: e.layout };
            }, o = u, s = [{ key: "definition", get: function get() {
                    return u.def;
                } }], (l = null) && a(o.prototype, l), s && a(o, s), u;
        }(n.a);l.customRegister = {};
    }, function (e, t, r) {
        e.exports = function (e) {
            var t = [];return t.toString = function () {
                return this.map(function (t) {
                    var r = function (e, t) {
                        var r = e[1] || "",
                            n = e[3];if (!n) return r;if (t && "function" == typeof btoa) {
                    ...
                    }(t, e);return t[2] ? "@media " + t[2] + "{" + r + "}" : r;
                }).join("");
            }, t.i = function (e, r) {
                "string" == typeof e && (e = [[null, e, ""]]);for (var n = {}, o = 0; o < this.length; o++) {
                    var i = this[o][0];null != i && (n[i] = !0);
                }for (o = 0; o < e.length; o++) {
                    var a = e[o];null != a[0] && n[a[0]] || (r && !a[2] ? a[2] = r : r && (a[2] = "(" + a[2] + ") and (" + r + ")"), t.push(a));
                }
            }, t;
        };
    }, function (e, t, r) {
        var n,
            ...
            var t = {};return function (e, r) {
                if ("function" == typeof e) return e();if (void 0 === t[e]) {
                    var n = l.call(this, e, r);if (window.HTMLIFrameElement && n instanceof window.HTMLIFrameElement) try {
            ...
            for (var r = 0; r < e.length; r++) {
                var n = e[r],
                    ...
                    o.refs++;for (var a = 0; a < o.parts.length; a++) {
                        ...
                        o.parts.push(y(n.parts[a], t));
                    }
                } else {
                    var l = [];for (a = 0; a < n.parts.length; a++) {
                        l.push(y(n.parts[a], t));
            ...
            for (var r = [], n = {}, o = 0; o < e.length; o++) {
                var i = e[o],
                    ...
                    l = { css: i[1], media: i[2], sourceMap: i[3] };n[a] ? n[a].parts.push(l) : r.push(n[a] = { id: a, parts: [l] });
            }return r;
        }function b(e, t) {
            var r = s(e.insertInto);if (!r) throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");var n = c[c.length - 1];if ("top" === e.insertAt) n ? n.nextSibling ? r.insertBefore(t, n.nextSibling) : r.appendChild(t) : r.insertBefore(t, r.firstChild), c.push(t);else if ("bottom" === e.insertAt) r.appendChild(t);else {
                if ("object" != _typeof(e.insertAt) || !e.insertAt.before) throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n");var o = s(e.insertAt.before, r);r.insertBefore(t, o);
            }
        }function h(e) {
            ...
            var r, n, o, i;if (t.transform && e.css) {
                ...
                var t = document.createElement("link");return void 0 === e.attrs.type && (e.attrs.type = "text/css"), e.attrs.rel = "stylesheet", v(t, e.attrs), b(e, t), t;
            }(t), n = k.bind(null, r, t), o = function o() {
                h(r), r.href && URL.revokeObjectURL(r.href);
            }) : (r = g(t), n = O.bind(null, r), o = function o() {
                h(r);
            ...
            if ("undefined" != typeof DEBUG && DEBUG && "object" != (typeof document === "undefined" ? "undefined" : _typeof(document))) throw new Error("The style-loader cannot be used in a non-browser environment");(t = t || {}).attrs = "object" == _typeof(t.attrs) ? t.attrs : {}, t.singleton || "boolean" == typeof t.singleton || (t.singleton = a()), t.insertInto || (t.insertInto = "head"), t.insertAt || (t.insertAt = "bottom");var r = m(e, t);return p(r, t), function (e) {
                for (var n = [], o = 0; o < r.length; o++) {
                    var a = r[o];(l = i[a.id]).refs--, n.push(l);
                }e && p(m(e, t), t);for (o = 0; o < n.length; o++) {
                    var l;if (0 === (l = n[o]).refs) {
            ...
            var o = r ? "" : n.css;if (e.styleSheet) e.styleSheet.cssText = x(t, o);else {
                var i = document.createTextNode(o),
                    a = e.childNodes;a[t] && e.removeChild(a[t]), a.length ? e.insertBefore(i, a[t]) : e.appendChild(i);
            }
        }function O(e, t) {
            var r = t.css,
                n = t.media;if (n && e.setAttribute("media", n), e.styleSheet) e.styleSheet.cssText = r;else {
                for (; e.firstChild;) {
                    e.removeChild(e.firstChild);
            ...
            var n = r.css,
                o = r.sourceMap,
                i = void 0 === t.convertToAbsoluteUrls && o;(t.convertToAbsoluteUrls || i) && (n = d(n)), o && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");var a = new Blob([n], { type: "text/css" }),
                l = e.href;e.href = URL.createObjectURL(a), l && URL.revokeObjectURL(l);
        }
    }, function (e, t) {
        e.exports = function (e) {
            var t = "undefined" != typeof window && window.location;if (!t) throw new Error("fixUrls requires window.location");if (!e || "string" != typeof e) return e;var r = t.protocol + "//" + t.host,
                n = r + t.pathname.replace(/\/[^\/]*$/, "/");return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
                var o,
        ...
        r.d(t, "a", function () {
            ...
            o = function o(e, t) {
            var r = e.id ? "formbuilder-" + e.type + " form-group field-" + e.id : "";if (e.className) {
                var n = e.className.split(" ");(n = n.filter(function (e) {
                    return (/^col-(xs|sm|md|lg)-([^\s]+)/.test(e) || e.startsWith("row-")
                    );
                })) && n.length > 0 && (r += " " + n.join(" "));for (var o = 0; o < n.length; o++) {
                    var i = n[o];t.classList.remove(i);
                }
            }return r;
        },
            i = function () {
            function e(e, t) {
                var r = this;this.preview = t, this.templates = { label: null, help: null, default: function _default(e, t, n, i) {
            ...
            }var t = e.prototype;return t.configure = function () {}, t.build = function (e, t, r) {
                this.preview && (t.name ? t.name = t.name + "-preview" : t.name = n.f.nameAttr(t) + "-preview"), t.id = t.name, this.data = jQuery.extend({}, t);var o = new e(t, this.preview),
                    i = o.build();"object" == (typeof i === "undefined" ? "undefined" : _typeof(i)) && i.field || (i = { field: i });
                var a,
                    l = this.label(),
                    s = this.help();a = r && this.isTemplate(r) ? r : this.isTemplate(i.layout) ? i.layout : "default";
                var u = this.processTemplate(a, i.field, l, s);return o.on("prerender")(u), u.addEventListener("fieldRendered", o.on("render")), u;
            }, t.label = function () {
                var e = this.data.label || "",
                    t = [n.f.parsedHtml(e)];return this.data.required && t.push(this.markup("span", "*", { className: "formbuilder-required" })), this.isTemplate("label") ? this.processTemplate("label", t) : this.markup("label", t, { for: this.data.id, className: "formbuilder-" + this.data.type + "-label" });
            }, t.help = function () {
                ...
                for (var t, r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) {
                    n[o - 1] = arguments[o];
                }var i = (t = this.templates)[e].apply(t, n.concat([this.data]));return i.jquery && (i = i[0]), i;
        ...
        var o = n(1),
            ...
            var r, n;function o() {
            ...
            }n = t, (r = o).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var l,
                s,
                u,
                f = o.prototype;return f.build = function () {
                var e = this,
                    t = this.config,
                    r = t.values,
                    n = t.type,
                    ...
                    var r = t.target.nextSibling.nextSibling,
                        ...
                        var t = e.getPreviousOption(o);t && e.selectOption(r, t);
                    }], [40, function () {
                        var t = e.getNextOption(o);t && e.selectOption(r, t);
                    }], [13, function () {
                        ...
                        e.hideList(r);
                    }]]).get(t.keyCode);return i || (i = function i() {
                        return !1;
                    }), i();
                },
                    l = { focus: function focus(t) {
                        var r = t.target.nextSibling.nextSibling,
                            n = Object(i.c)(r.querySelectorAll("li"), t.target.value);if (t.target.addEventListener("keydown", a), t.target.value.length > 0) {
                            var o = n.length > 0 ? n[n.length - 1] : null;e.showList(r, o);
                        }
                        ...
                        if (t.target.removeEventListener("keydown", a), setTimeout(function () {
                            ...
                            var r = t.target.nextSibling.nextSibling;e.isOptionValid(r, t.target.value) || (t.target.value = "", t.target.nextSibling.value = "");
                        }
                    }, input: function input(t) {
                        var r = t.target.nextSibling.nextSibling;t.target.nextSibling.value = t.target.value;var n = Object(i.c)(r.querySelectorAll("li"), t.target.value);if (0 == n.length) e.hideList(r);else {
                            var o = e.getActiveOption(r);o || (o = n[n.length - 1]), e.showList(r, o);
                        }
                    } },
                    s = Object.assign({}, o, { id: o.id + "-input", autocomplete: "off", events: l }),
                    u = Object.assign({}, o, { type: "hidden" });delete s.name;var f = [this.markup("input", null, s), this.markup("input", null, u)],
                    c = r.map(function (t) {
                    var r = t.label,
                        n = { events: { click: function click(r) {
                                var n = r.target.parentElement,
                                    o = n.previousSibling.previousSibling;o.value = t.label, o.nextSibling.value = t.value, e.hideList(n);
                            } }, value: t.value };return e.markup("li", r, n);
                ...
                var t = e.getElementsByClassName("active-option")[0];return t && "none" !== t.style.display ? t : null;
            }, f.getPreviousOption = function (e) {
                var t = e;do {
                    t = t ? t.previousSibling : null;
                } while (null != t && "none" === t.style.display);return t;
                ...
                if (this.config.userData) {
                    var r = e("#" + this.config.name),
                        ...
                        i = null;if (n.find("li").each(function () {
                        e(this).attr("value") !== o || (i = e(this).get(0));
                    }), null === i) return this.config.requireValidOption ? void 0 : void r.prev().val(this.config.userData[0]);r.prev().val(i.innerHTML), r.val(i.getAttribute("value"));var a = r.next().get(0);"none" === a.style.display ? this.showList(a, i) : this.hideList(a);
                }return t;
            }, l = o, u = [{ key: "definition", get: function get() {
                    return { mi18n: { requireValidOption: "requireValidOption" } };
                } }], (s = null) && a(l.prototype, s), u && a(l, u), o;
        }(o.a);o.a.register("autocomplete", l);var s = function (e) {
            var t, r;function n() {
                return e.apply(this, arguments) || this;
        ...
        }(o.a);o.a.register("button", s), o.a.register(["button", "submit", "reset"], s, "button");var u = n(6);var f = function (t) {
            var r, n;function o() {
                return t.apply(this, arguments) || this;
            }n = t, (r = o).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var i = o.prototype;return i.build = function () {
        ...
        }(o.a);o.a.register("hidden", f);var c = n(0);var d = function (e) {
            var t, r;function n() {
                return e.apply(this, arguments) || this;
            }return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n.prototype.build = function () {
                var e = this.config,
                    ...
                    n = t,
                    o = { paragraph: "p", header: this.subtype };return o[t] && (n = o[t]), { field: this.markup(n, c.f.parsedHtml(this.label), r), layout: "noLabel" };
            }, n;
        }(o.a);function p(e, t) {
            if (null == e) return {};var r,
                n,
        ...
        }o.a.register(["paragraph", "header"], d), o.a.register(["p", "address", "blockquote", "canvas", "output"], d, "paragraph"), o.a.register(["h1", "h2", "h3", "h4", "h5", "h6"], d, "header");var b = function (t) {
            var r, n;function i() {
                return t.apply(this, arguments) || this;
            }n = t, (r = i).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var a,
                l,
                s,
                u = i.prototype;
            return u.build = function () {
                var e = [],
                    ...
                    l = t.others,
                    s = t.toggle,
                    u = p(t, ["values", "value", "placeholder", "type", "inline", "others", "toggle"]),
                    f = i.replace("-group", ""),
                    c = "select" === i;
                if ((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, r) {
                    ...
                    for (var d = 0; d < r.length; d++) {
                        var m = r[d];"string" == typeof m && (m = { label: m, value: m });var b = m,
                            h = b.label,
                            g = void 0 === h ? "" : h;if ((j = p(b, ["label"])).id = u.id + "-" + d, j.selected && !o || delete j.selected, void 0 !== n && j.value === n && (j.selected = !0), c) {
                            var v = this.markup("option", document.createTextNode(g), j);e.push(v);
                        } else {
                            var y = [g],
                                w = "formbuilder-" + f;a && (w += "-inline"), j.type = f, j.selected && (j.checked = "checked", delete j.selected);var x = this.markup("input", null, Object.assign({}, u, j)),
                                A = { for: j.id },
                                O = [x, this.markup("label", y, A)];s && (A.className = "kc-toggle", y.unshift(x, this.markup("span")), O = this.markup("label", y, A));
                            var k = this.markup("div", O, { className: w });e.push(k);
                        }
                    }if (!c && l) {
                        var j,
                            q = { id: u.id + "-other", className: u.className + " other-option", value: "" },
                            C = "formbuilder-" + f;a && (C += "-inline"), (j = Object.assign({}, u, q)).type = f;
                        var E = { type: "text", events: { input: function input(e) {
                                    var t = e.target;t.parentElement.previousElementSibling.value = t.value;
                                } }, id: q.id + "-value", className: "other-val" },
                            L = this.markup("input", null, j),
                            N = [document.createTextNode("Others"), this.markup("input", null, E)],
                            S = this.markup("label", N, { for: j.id }),
                            T = this.markup("div", [L, S], { className: C });e.push(T);
                    }
                ...
                for (var e = this.element.getElementsByTagName("input"), t = function t(e, _t) {
                    [].forEach.call(e, function (e) {
                        _t ? e.removeAttribute("required") : e.setAttribute("required", "required"), function (e, t) {
                            var r = o.a.mi18n("minSelectionRequired", 1);t ? e.setCustomValidity("") : e.setCustomValidity(r);
                        }(e, _t);
                    });
                }, r = function r() {
                ...
                if (this.config.userData) {
                    var t = this.config.userData.slice();"select" === this.config.type ? e(this.dom).val(t).prop("selected", !0) : this.config.type.endsWith("-group") && this.dom.querySelectorAll("input").forEach(function (e) {
                        if (!e.classList.contains("other-val")) {
                            for (var r = 0; r < t.length; r++) {
                                if (e.value === t[r]) {
                                    e.setAttribute("checked", !0), t.splice(r, 1);break;
                                }
                            }if (e.id.endsWith("-other")) {
                                var n = document.getElementById(e.id + "-value");if (0 === t.length) return;e.setAttribute("checked", !0), n.value = e.value = t[0], n.style.display = "inline-block";
                            }
                        }
                    });
                }
            }, a = i, s = [{ key: "definition", get: function get() {
        ...
        }o.a.register(["select", "checkbox-group", "radio-group", "checkbox"], b);var g = function (t) {
            var r, n;function o() {
                return t.apply(this, arguments) || this;
            }n = t, (r = o).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var i,
                a,
                l,
                s = o.prototype;return s.build = function () {
                var e = this.config.name;e = this.config.multiple ? e + "[]" : e;var t = Object.assign({}, this.config, { name: e });return this.dom = this.markup("input", null, t), this.dom;
            }, s.onRender = function () {
                this.config.userData && e(this.dom).val(this.config.userData[0]);
            }, i = o, l = [{ key: "definition", get: function get() {
        ...
        }o.a.register(["text", "file", "date", "number"], g), o.a.register(["text", "password", "email", "color", "tel"], g, "text");var y = function (t) {
            var r, n;function o() {
                return t.apply(this, arguments) || this;
            }n = t, (r = o).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var i,
                a,
                l,
                s = o.prototype;return s.configure = function () {
                var t = this;this.js = this.classConfig.js || "//cdnjs.cloudflare.com/ajax/libs/file-uploader/5.14.2/jquery.fine-uploader/jquery.fine-uploader.min.js", this.css = [this.classConfig.css || "//cdnjs.cloudflare.com/ajax/libs/file-uploader/5.14.2/jquery.fine-uploader/fine-uploader-gallery.min.css", { type: "inline", id: "fineuploader-inline", style: "\n          .qq-uploader .qq-error-message {\n            position: absolute;\n            left: 20%;\n            top: 20px;\n            width: 60%;\n            color: #a94442;\n            background: #f2dede;\n            border: solid 1px #ebccd1;\n            padding: 15px;\n            line-height: 1.5em;\n            text-align: center;\n            z-index: 99999;\n          }\n          .qq-uploader .qq-error-message span {\n            display: inline-block;\n            text-align: left;\n          }" }], this.handler = this.classConfig.handler || "/upload";["js", "css", "handler"].forEach(function (e) {
                ...
                var t = e(this.wrapper),
                    r = e(this.input),
                    n = jQuery.extend(!0, { request: { endpoint: this.handler }, deleteFile: { enabled: !0, endpoint: this.handler }, chunking: { enabled: !0, concurrent: { enabled: !0 }, success: { endpoint: this.handler + (-1 == this.handler.indexOf("?") ? "?" : "&") + "done" } }, resume: { enabled: !0 }, retry: { enableAuto: !0, showButton: !0 }, callbacks: { onError: function onError(r, n, o) {
                            "." != o.slice(-1) && (o += ".");var i = e("<div />").addClass("qq-error-message").html("<span>Error processing upload: <b>" + n + "</b>.<br />Reason: " + o + "</span>").prependTo(t.find(".qq-uploader")),
                            ...
                            var i = [],
                                ...
                                l = Array.isArray(a),
                                s = 0;for (a = l ? a : a[Symbol.iterator]();;) {
                                var u;if (l) {
                                    if (s >= a.length) break;u = a[s++];
                                } else {
                                    if ((s = a.next()).done) break;u = s.value;
                                }var f = u;"upload successful" == f.status && i.push(f.name);
                            }return r.val(i.join(", ")), { id: e, oldStatus: n, newStatus: o };
                        } }, template: this.fineTemplate }, this.classConfig);t.fineUploader(n);
            }, i = o, l = [{ key: "definition", get: function get() {
        ...
        }g.register("file", g, "file"), g.register("fineuploader", y, "file");var x = function (t) {
            var r, n;function o() {
                return t.apply(this, arguments) || this;
            }n = t, (r = o).prototype = Object.create(n.prototype), r.prototype.constructor = r, r.__proto__ = n;var i,
                a,
                ...
                }(e, ["value"]);return this.field = this.markup("textarea", this.parsedHtml(r), n), this.field;
            }, s.onRender = function () {
                this.config.userData && e("#" + this.config.name).val(this.config.userData[0]);
            }, s.on = function (r) {
                var n = this;return "prerender" == r && this.preview ? function (t) {
        ...
        }(o.a);o.a.register("textarea", x), o.a.register("textarea", x, "textarea");var A = function (e) {
            var t, r;function n() {
                return e.apply(this, arguments) || this;
            }r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r;var o = n.prototype;return o.configure = function () {
                if (this.js = ["https://cdn.tinymce.com/4/tinymce.min.js"], this.classConfig.js) {
                    var e = this.classConfig.js;Array.isArray(e) || (e = new Array(e)), this.js.concat(e), delete this.classConfig.js;
                ...
                }(e, ["value"]);return this.field = this.markup("textarea", this.parsedHtml(r), n), n.disabled && (this.editorOptions.readonly = !0), this.field;
            }, o.onRender = function (e) {
                window.tinymce.editors[this.id] && window.tinymce.editors[this.id].remove();var t = jQuery.extend(this.editorOptions, this.classConfig);return t.target = this.field, window.tinymce.init(t), this.config.userData && window.tinymce.editors[this.id].setContent(this.parsedHtml(this.config.userData[0])), e;
            }, n;
        }(x);function O(e) {
            for (var t = 1; t < arguments.length; t++) {
                var r = null != arguments[t] ? arguments[t] : {},
            ...
            return t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
        }x.register("tinymce", A, "textarea");var j = function (e) {
            var t, r;function n() {
                return e.apply(this, arguments) || this;
            }r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r;var o = n.prototype;return o.configure = function () {
                var e = { modules: { toolbar: [[{ header: [1, 2, !1] }], ["bold", "italic", "underline"], ["code-block"]] }, placeholder: this.config.placeholder || "", theme: "snow" },
                    ...
                    r = t[0],
                    n = t[1];Object.assign(this, O({}, { js: "//cdn.quilljs.com/1.2.4/quill.js", css: "//cdn.quilljs.com/1.2.4/quill.snow.css" }, r)), this.editorConfig = O({}, e, n);
            }, o.build = function () {
                var e = this.config,
                ...
                }(e, ["value"]));return this.field = this.markup("div", null, t), this.field;
            }, o.onRender = function (e) {
                var t = this.config.value || "",
                    r = window.Quill.import("delta");window.fbEditors.quill[this.id] = {};var n = window.fbEditors.quill[this.id];return n.instance = new window.Quill(this.field, this.editorConfig), n.data = new r(), t && n.instance.setContents(window.JSON.parse(this.parsedHtml(t))), n.instance.on("text-change", function (e) {
                    n.data = n.data.compose(e);
                }), e;
            }, n;
        }(x);x.register("quill", j, "textarea");u.a;
    }, function (e, t, r) {
        var n = r(20),
            o = "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self && self.Object === Object && self,
            i = n || o || Function("return this")();e.exports = i;
    }, function (e, t, r) {
        var n = r(13).Symbol;e.exports = n;
    }, function (e, t, r) {
        var n = r(18),
            o = r(11),
            i = "Expected a function";e.exports = function (e, t, r) {
            var a = !0,
                l = !0;if ("function" != typeof e) throw new TypeError(i);return o(r) && (a = "leading" in r ? !!r.leading : a, l = "trailing" in r ? !!r.trailing : l), n(e, t, { leading: a, maxWait: t, trailing: l });
        };
    }, function (e, t, r) {
        var n = r(17);"string" == typeof n && (n = [[e.i, n, ""]]);var o = { attrs: { class: "formBuilder-injected-style" }, sourceMap: !1, hmr: !0, transform: void 0, insertInto: void 0 };r(8)(n, o);n.locals && (e.exports = n.locals);
    }, function (e, t, r) {
        ...
        var n = r(11),
            ...
            var u,
                ...
                h = !1,
                g = !1,
                v = !0;if ("function" != typeof e) throw new TypeError(a);function y(t) {
                var r = u,
                    n = f;return u = f = void 0, b = t, d = e.apply(n, r);
            }function w(e) {
                var r = e - m;return void 0 === m || r >= t || r < 0 || g && e - b >= c;
            }function x() {
                var e = o();if (w(e)) return A(e);p = setTimeout(x, function (e) {
                    var r = t - (e - m);return g ? s(r, c - (e - b)) : r;
                }(e));
            }function A(e) {
                return p = void 0, v && u ? y(e) : (u = f = void 0, d);
            }function O() {
                var e = o(),
                    r = w(e);if (u = arguments, f = this, m = e, r) {
                    if (void 0 === p) return function (e) {
                        return b = e, p = setTimeout(x, t), h ? y(e) : d;
                    }(m);if (g) return clearTimeout(p), p = setTimeout(x, t), y(m);
        ...
        var n = r(11),
            ...
            s = /^0b[01]+$/i,
            u = /^0o[0-7]+$/i,
            f = parseInt;e.exports = function (e) {
            if ("number" == typeof e) return e;if (o(e)) return i;if (n(e)) {
                var t = "function" == typeof e.valueOf ? e.valueOf() : e;e = n(t) ? t + "" : t;
            }if ("string" != typeof e) return 0 === e ? e : +e;e = e.replace(a, "");var r = s.test(e);return r || u.test(e) ? f(e.slice(2), r ? 2 : 8) : l.test(e) ? i : +e;
        };
    }, function (e, t, r) {
        var n = r(24),
            o = r(27),
            i = "[object Symbol]";e.exports = function (e) {
            return "symbol" == (typeof e === "undefined" ? "undefined" : _typeof(e)) || o(e) && n(e) == i;
        };
    }, function (e, t, r) {
        var n = r(14),
            o = r(25),
        ...
        var n = r(14),
            ...
            i = o.hasOwnProperty,
            a = o.toString,
            l = n ? n.toStringTag : void 0;e.exports = function (e) {
            var t = i.call(e, l),
                r = e[l];try {
                e[l] = void 0;var n = !0;
            } catch (e) {}var o = a.call(e);return n && (t ? e[l] = r : delete e[l]), o;
        };
    }, function (e, t) {
        ...
        n.r(r);n(16);var o = n(15),
            ...
            function t(e, t, r) {
            ...
            }var r = t.prototype;return r.startMoving = function (e, t) {
                ...
                var r = m.a.opts,
                    ...
                    o = [];this.stopIndex = t.placeholder.index() - 1, !r.sortableControls && t.item.parent().hasClass("frmb-control") && o.push(!0), r.prepend && o.push(0 === this.stopIndex), r.append && o.push(this.stopIndex + 1 === n), this.doCancel = o.some(function (e) {
                    return !0 === e;
                });
            }, r.getTypes = function (t) {
                var r = { type: t.attr("type") },
                    n = e(".fld-subtype", t).val();return n !== r.type && (r.subtype = n), r;
            }, r.fieldOptionData = function (t) {
                var r = [],
                    n = e(".sortable-options li", t);return n.each(function (t) {
                    var o = e(n[t]),
                        i = e(".option-selected", o).is(":checked"),
                        a = { label: e(".option-label", o).val(), value: e(".option-value", o).val() };i && (a.selected = i), r.push(a);
                }), r;
            }, r.xmlSave = function (e) {
                var t = this.prepData(e),
                    r = new XMLSerializer(),
                    n = ["<fields>"];t.forEach(function (e) {
                    var t = e.values,
                        r = g(e, ["values"]),
                        o = ["<field " + Object(p.B)(r) + ">"];if (a.e.includes(e.type)) {
                        var i = t.map(function (e) {
                            return Object(p.p)("option", e.label, e).outerHTML;
                        });o = o.concat(i);
                    }o.push("</field>"), n.push(o);
                }), n.push("</fields>");var o = Object(p.p)("form-template", Object(p.h)(n).join(""));return r.serializeToString(o);
            }, r.prepData = function (t) {
                var r = [],
                    n = this.d,
                    o = this;return 0 !== t.childNodes.length && Object(p.i)(t.childNodes, function (t, i) {
                    var a = e(i);
                    if (!a.hasClass("disabled-field")) {
                        var l = o.getTypes(a),
                            ...
                            u = s.map(function (e) {
                            return s[e].value;
                        }).get();if ((l = Object.assign({}, l, o.getAttrVals(i))).subtype) if ("quill" === l.subtype) {
                            var f = l.name + "-preview";if (window.fbEditors.quill[f]) {
                                var c = window.fbEditors.quill[f].instance.getContents();l.value = window.JSON.stringify(c.ops);
                            }
                        } else if ("tinymce" === l.subtype && window.tinymce) {
                            var d = l.name + "-preview";if (window.tinymce.editors[d]) {
                                var m = window.tinymce.editors[d];l.value = m.getContent();
                            }
                        }if (u.length && (l.role = u.join(",")), l.className = l.className || l.class, l.className) {
                            var b = /(?:^|\s)btn-(.*?)(?:\s|$)/g.exec(l.className);b && (l.style = b[1]);
                        }(l = Object(p.z)(l)).type && l.type.match(n.optionFieldsRegEx) && (l.values = o.fieldOptionData(a)), r.push(l);
                    }
                }), r;
            }, r.getData = function (e) {
                var t = this.data;if (e || (e = m.a.opts.formData), !e) return !1;var r = { xml: function xml(e) {
                ...
                var r = Object.create(null),
                    n = t.querySelectorAll('[class*="fld-"]');return Object(p.i)(n, function (t) {
                    var o = n[t],
                ...
                var r = this.d,
                    n = t.attr("class"),
                    o = t[0];if (!n.includes("input-control")) {
                    var i = t.attr("type"),
                        l = e(".prev-holder", o),
                        s = Object.assign({}, this.getAttrVals(o, s), { type: i });i.match(r.optionFieldsRegEx) && (s.values = [], s.multiple = e('[name="multiple"]', o).is(":checked"), e(".sortable-options li", o).each(function (t, r) {
                        var n = { selected: e(".option-selected", r).is(":checked"), value: e(".option-value", r).val(), label: e(".option-label", r).val() };s.values.push(n);
                    })), (s = Object(p.z)(s)).className = this.classNames(o, s), t.data("fieldData", s);var u = h.a.lookup(s.type),
                        f = u ? u.class : b.a.getClass(s.type, s.subtype),
                        d = this.layout.build(f, s);Object(a.b)(l[0]), l[0].appendChild(d), d.dispatchEvent(c.a.fieldRendered);
                }
            }, r.disabledTT = function (e) {
                var t = e.querySelectorAll(".disabled-field");Object(p.i)(t, function (e) {
                    var r = t[e],
                        n = f.a.get("fieldNonEditable");if (n) {
                        var o = Object(p.p)("p", n, { className: "frmb-tt" });r.appendChild(o), r.addEventListener("mousemove", function (e) {
                            return function (e, t) {
                                var r = t.field.getBoundingClientRect(),
                                    n = e.clientX - r.left - 21,
                                    o = e.clientY - r.top - t.tt.offsetHeight - 12;t.tt.style.transform = "translate(" + n + "px, " + o + "px)";
                            }(e, { tt: o, field: r });
                        });
                    }
                });
                ...
                var n = t.querySelector(".fld-className"),
                    ...
                    var a = r.type,
                        ...
                        s = { button: "btn", submit: "btn" }[a];if (s && i) {
                        for (var u = 0; u < l.length; u++) {
                            var f = new RegExp("^" + s + "-.*", "g");l[u].match(f) ? l.splice(u, 1, s + "-" + i) : l.push(s + "-" + i);
                        }l.push(s);
                    }var c = Object(p.A)(l).join(" ").trim();return n.value = c, c;
                }
                ...
                var e = this,
                    t = Object(p.p)("div", null, { className: "form-builder-overlay" });return document.body.appendChild(t), t.classList.add("visible"), t.addEventListener("click", function (t) {
                    var r = t.target;return e.closeConfirm(r);
                }, !1), document.addEventListener("keydown", this.handleKeyDown, !1), t;
            }, r.confirm = function (e, t, r, n) {
                void 0 === r && (r = !1), void 0 === n && (n = "");var o = this,
                    i = f.a.current,
                    a = o.showOverlay(),
                    l = Object(p.p)("button", i.yes, { className: "yes btn btn-success btn-sm" }),
                    s = Object(p.p)("button", i.no, { className: "no btn btn-danger btn-sm" });s.onclick = function () {
                    o.closeConfirm(a);
                }, l.onclick = function () {
                    t(), o.closeConfirm(a);
                };var u = Object(p.p)("div", [s, l], { className: "button-wrap" });n = "form-builder-dialog " + n;var c = Object(p.p)("div", [e, u], { className: n });if (r) c.classList.add("positioned");else {
                    var d = document.documentElement;r = { pageX: Math.max(d.clientWidth, window.innerWidth || 0) / 2, pageY: Math.max(d.clientHeight, window.innerHeight || 0) / 2 }, c.style.position = "fixed";
                }return c.style.left = r.pageX + "px", c.style.top = r.pageY + "px", document.body.appendChild(c), l.focus(), c;
            }, r.dialog = function (e, t, r) {
                void 0 === t && (t = !1), void 0 === r && (r = "");var n = document.documentElement.clientWidth,
                    o = document.documentElement.clientHeight;this.showOverlay(), r = "form-builder-dialog " + r;var i = Object(p.p)("div", e, { className: r });return t ? i.classList.add("positioned") : (t = { pageX: Math.max(n, window.innerWidth || 0) / 2, pageY: Math.max(o, window.innerHeight || 0) / 2 }, i.style.position = "fixed"), i.style.left = t.pageX + "px", i.style.top = t.pageY + "px", document.body.appendChild(i), document.dispatchEvent(c.a.modalOpened), -1 !== r.indexOf("data-dialog") && document.dispatchEvent(c.a.viewData), i;
                ...
                var r = this,
                    ...
                    u = { pageX: l.left + l.width / 2, pageY: l.top - s.top - 12 };a.length ? r.confirm(i.clearAllMessage, function () {
                ...
                var r = this;void 0 === t && (t = !0);var n = f.a.current,
                    o = m.a.opts,
                    i = e.querySelectorAll("li.form-field"),
                    l = [];if (!i.length) return !1;if (o.prepend && l.push(!0), o.append && l.push(!0), l.some(function (e) {
                    return !0 === e;
                }) || (e.classList.add("empty"), e.dataset.content = n.getStarted), t) {
                    e.classList.add("removing");var s = 0;Object(p.i)(i, function (e) {
                ...
                if (!m.a.opts.sortableControls) return !1;var r = window,
                    n = r.sessionStorage,
                    o = r.JSON,
                    i = [];return t.children().each(function (t, r) {
                    var n = e(r).data("type");n && i.push(n);
                }), n && n.setItem("fieldOrder", o.stringify(i)), i;
            }, r.closeAllEdit = function () {
                var t = e("> li.editing", this.d.stage),
                    r = e(".toggle-form", this.d.stage),
                    n = e(".frm-holder", t);r.removeClass("open"), t.removeClass("editing"), e(".prev-holder", t).show(), n.hide();
            }, r.toggleEdit = function (t, r) {
                void 0 === r && (r = !0);var n = document.getElementById(t);if (!n) return n;var o = e(".frm-holder", n),
                    i = e(".prev-holder", n);return n.classList.toggle("editing"), e(".toggle-form", n).toggleClass("open"), r ? (i.slideToggle(250), o.slideToggle(250)) : (i.toggle(), o.toggle()), this.updatePreview(e(n)), n.classList.contains("editing") ? (this.formBuilder.currentEditPanel = o[0], m.a.opts.onOpenFieldEdit(o[0]), document.dispatchEvent(c.a.fieldEditOpened)) : (m.a.opts.onCloseFieldEdit(o[0]), document.dispatchEvent(c.a.fieldEditClosed)), n;
            }, r.getStyle = function (e, t) {
                var r;return void 0 === t && (t = !1), window.getComputedStyle ? r = window.getComputedStyle(e, null) : e.currentStyle && (r = e.currentStyle), t ? r[t] : r;
                ...
                var t = this.d,
                    ...
                    a = n.getBoundingClientRect().top;e(window).scroll(function (t) {
                    var l = e(t.target).scrollTop(),
                        s = { top: 5, bottom: "auto", right: "auto", left: i.left },
                        u = Object.assign({}, s, m.a.opts.stickyControls.offset);if (l > a) {
                        var f = Object.assign({ position: "sticky" }, u),
                            c = r.getBoundingClientRect(),
                            d = n.getBoundingClientRect(),
                            p = c.top + c.height,
                            b = d.top + d.height,
                            h = p === b && c.top > l;p > b && c.top !== d.top && o.css({ position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto" }), (p < b || h) && o.css(f);
                    } else r.parentElement.removeAttribute("style");
                });
            }, r.showData = function () {
                var e = this.getFormData(m.a.opts.dataType, !0);"xml" === m.a.opts.dataType && (e = Object(p.g)(e));var t = Object(p.p)("code", e, { className: "formData-" + m.a.opts.dataType });this.dialog(Object(p.p)("pre", t), null, "data-dialog");
            }, r.removeField = function (t, r) {
                void 0 === r && (r = 250);var n = !1,
                    o = this,
                    i = this.d.stage,
                    a = i.getElementsByClassName("form-field");if (!a.length) return m.a.opts.notify.warning("No fields to remove"), !1;var l = t && document.getElementById(t);if (!t || !l) {
                ...
                }var u = e(l);if (!l) return m.a.opts.notify.warning("Field not found"), !1;u.slideUp(r, function () {
                ...
                });var d = m.a.opts.typeUserEvents[l.type];return d && d.onremove && d.onremove(l), document.dispatchEvent(c.a.fieldRemoved), n;
            }, r.processActionButtons = function (e) {
                var t = e.label,
                    r = e.events,
                    n = g(e, ["label", "events"]),
                    o = t,
                    i = this.data;o = o ? f.a.current[o] || o : n.id ? f.a.current[n.id] || Object(p.d)(n.id) : "", n.id ? n.id = i.formID + "-" + n.id + "-action" : n.id = i.formID + "-action-" + Math.round(1e3 * Math.random());var a = Object(p.p)("button", o, n);if (r) {
                    var l = function l(e) {
                ...
                var t = m.a.opts.disabledSubtypes;for (var r in e) {
                    ...
                    var n = r[0],
                        o = r[1];return e[n] = t[n] && Object(p.x)(t[n], o) || o, e;
                }, {}),
                    i = {};for (var a in o) {
                    if (o.hasOwnProperty(a)) {
                        var l = [],
                            s = o[a],
                            u = Array.isArray(s),
                            f = 0;for (s = u ? s : s[Symbol.iterator]();;) {
                            var c;if (u) {
                                if (f >= s.length) break;c = s[f++];
                            } else {
                                if ((f = s.next()).done) break;c = f.value;
                            }var d = c,
                                h = b.a.getClass(a, d),
                                g = h.mi18n("subtype." + d) || h.mi18n(d) || d;l.push({ label: g, value: d });
                        }i[a] = l;
                    }
                }return i;
                ...
                var t = this.d,
                    r = this.data,
                    n = e || r.formID;t.editorWrap = Object(p.p)("div", null, { id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.q)() }), t.stage = Object(p.p)("ul", null, { id: n, className: "frmb stage-wrap " + r.layout.stage }), t.controls = Object(p.p)("ul", null, { id: n + "-control-box", className: "frmb-control" });var o = this.formActionButtons();t.formActions = Object(p.p)("div", o, { className: "form-actions btn-group" });
            }, r.formActionButtons = function () {
                var e = this,
                    t = m.a.opts;return t.actionButtons.map(function (r) {
                ...
                var t = this,
                    ...
                    i = o.fieldEditContainer;"string" == typeof o.fieldEditContainer && (i = document.querySelector(o.fieldEditContainer));var a = [{ type: "button", id: "clear", className: "clear-all btn btn-danger", events: { click: t.confirmRemoveAll.bind(t) } }, { type: "button", label: "viewJSON", id: "data", className: "btn btn-default get-data", events: { click: t.showData.bind(t) } }, { type: "button", id: "save", className: "btn btn-primary save-template", events: { click: function click(e) {
                        ...
                        } } }].concat(r);return o.fields = o.fields.concat(n), o.disableFields = o.disableFields.concat(n.map(function (e) {
                    var t = e.type;return t && t;
                ...
                void 0 === e && (e = "js"), void 0 === t && (t = !1);var r = this;return { js: function js() {
            ...
            function e(e, t) {
                ...
                var e = this,
                    t = this.opts;b.a.loadCustom(t.controls), Object.keys(t.fields).length && h.a.register(t.templates, t.fields);var r = b.a.getRegistered();this.registeredControls = r;var n = h.a.getRegistered();n && jQuery.merge(r, n), t.sortableControls && this.dom.classList.add("sort-enabled"), this.controlList = [], this.allControls = {};for (var o = 0; o < r.length; o++) {
                    var i = r[o],
                        a = h.a.lookup(i),
                        l = void 0;if (a) l = a.class;else if (a = {}, !(l = b.a.getClass(i)) || !l.active(i)) continue;var s = a.icon || l.icon(i),
                        u = a.label || l.label(i),
                        f = s ? "" : a.iconClassName || "icon-" + i.replace(/-[\d]{4}$/, "");s && (u = '<span class="control-icon">' + s + "</span>" + u);var c = Object(p.p)("li", Object(p.p)("span", u), { className: f + " input-control input-control-" + o });c.dataset.type = i, this.controlList.push(i), this.allControls[i] = c;
                }t.inputSets.length && t.inputSets.forEach(function (t, r) {
                    var n = t.name,
                        o = t.label;n = n || Object(p.m)(o), t.icon && (o = '<span class="control-icon">' + t.icon + "</span>" + o);var i = Object(p.p)("li", o, { className: "input-set-control input-set-" + r });i.dataset.type = n, e.controlList.push(n), e.allControls[n] = i;
                });
            }, t.orderFields = function (e) {
                var t,
                    r = this.opts,
                    n = r.controlOrder.concat(e);return window.sessionStorage && (r.sortableControls ? t = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), t ? (t = window.JSON.parse(t), t = Object(p.A)(t.concat(e)), t = Object.keys(t).map(function (e) {
                    return t[e];
                })) : t = Object(p.A)(n), t.forEach(function (e) {
                    var r = new RegExp("-[\\d]{4}$");if (e.match(r)) {
                ...
                var e = this;Object(a.b)(this.dom), this.orderFields(this.controlList).forEach(function (t) {
                    var r = e.allControls[t];r && e.dom.appendChild(r);
                });
            }, e;
        }());function w(e, t) {
            if (null == e) return {};var r,
            ...
            var n = this,
                ...
                b = new s(u),
                h = new a.a(u);e.layout || (e.layout = d.a);
            var g = new e.layout(e.layoutTemplates, !0),
                A = new v(u, g, o),
                O = p.p;e = A.processOptions(e), b.layout = A.editorLayout(e.controlPosition), A.editorUI(u), b.formID = u, b.lastID = b.formID + "-fld-0";
            var k = new y(e, h),
                j = m.a.subtypes = A.processSubtypes(e.subtypes),
                q = r(h.stage),
                C = r(h.controls);q.sortable({ cursor: "move", opacity: .9, revert: 150, beforeStop: function beforeStop(e, t) {
                ...
                }, cancel: ["input", "select", "textarea", ".disabled-field", ".form-elements", ".btn", "button", ".is-locked"].join(", "), placeholder: "frmb-placeholder" }), e.allowStageSort || q.sortable("disable"), C.sortable({ helper: "clone", opacity: .9, connectWith: q, cancel: ".formbuilder-separator", cursor: "move", scroll: !1, placeholder: "ui-state-highlight", start: function start(e, t) {
                    return A.startMoving.call(A, e, t);
                }, stop: function stop(e, t) {
                    return A.stopMoving.call(A, e, t);
                }, revert: 150, beforeStop: function beforeStop(e, t) {
                    return A.beforeStop.call(A, e, t);
                }, distance: 3, update: function update(t, r) {
                    if (A.doCancel) return !1;r.item.parent()[0] === h.stage ? (A.doCancel = !0, E(r.item)) : (A.setFieldOrder(C), A.doCancel = !e.sortableControls);
                } });var E = function E(t) {
                if (t[0].classList.contains("input-set-control")) {
                    var r = [],
                        ...
                        var o = { type: "header", subtype: "h2", id: n.name, label: n.label };r.push(o);
                ...
                L = r(h.editorWrap),
                N = O("div", h.controls, { id: b.formID + "-cb-wrap", className: "cb-wrap " + b.layout.controls });e.showActionButtons && N.appendChild(h.formActions), L.append(h.stage, N), "textarea" !== t.type ? r(t).append(L) : r(t).replaceWith(L), r(h.controls).on("click", "li", function (e) {
                var t = e.target,
                    n = r(t).closest("li");A.stopIndex = void 0, E(n), A.save.call(A);
            });var S = function S(t, n) {
                void 0 === n && (n = !1);var o = {};if (t instanceof jQuery) {
                    if (o.type = t[0].dataset.type, o.type) {
                        var i = k.custom.lookup(o.type);if (i) o = Object.assign({}, i);else {
                            var a = k.getClass(o.type);o.label = a.label(o.type);
                        }
                    } else {
                        var l = t[0].attributes;n || (o.values = t.children().map(function (e, t) {
                ...
                } else o = Object.assign({}, t);o.name || (o.name = Object(p.r)(o)), n && ["text", "number", "file", "date", "select", "textarea", "autocomplete"].includes(o.type) && (o.className = o.className || "form-control");var u = /(?:^|\s)btn-(.*?)(?:\s|$)/g.exec(o.className);u && (o.style = u[1]), n && setTimeout(function () {
                    return document.dispatchEvent(c.a.fieldAdded);
                }, 10), e.onAddField(b.lastID, o), V(o, n), h.stage.classList.remove("empty");
            },
                T = function T(t) {
                var n, o;(t = A.getData(t)) && t.length ? (t.forEach(function (e) {
                    ...
                    return S(e);
                }), h.stage.classList.remove("empty")) : e.prepend || e.append || (h.stage.classList.add("empty"), h.stage.dataset.content = f.a.get("getStarted")), n = [], o = function o(t) {
                ...
                var t,
                    ...
                    l = e.multiple || "checkbox-group" === r;if (n && n.length) t = n.map(function (e) {
                    return Object.assign({}, { selected: !1 }, e);
                });else {
                    var s = [1, 2, 3];["checkbox-group", "checkbox"].includes(r) && (s = [1]);var u = (t = s.map(function (e) {
                        return t = "" + f.a.get("optionCount", e), n = { label: t, value: Object(p.m)(t) }, "autocomplete" !== r && (n.selected = !1), n;var t, n;
                    }))[0];u.hasOwnProperty("selected") && "radio-group" !== r && (u.selected = !0);
                }var c = O("div", i, { className: "option-actions" }),
                    d = O("ol", t.map(function (e) {
                    return Y(o, e, l);
                }), { className: "sortable-options" }),
                    m = O("div", [d, c], { className: "sortable-options-wrap" });return a.push(m), O("div", a, { className: "form-group field-options" }).outerHTML;
            },
                B = function B(t) {
                var r,
                    n = t.type,
                    ...
                    var t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                        ...
                        checkbox: ["required", "label", "description", "toggle", "inline", "className", "name", "access", "others", "options"],
                        text: t.concat(["subtype", "maxlength"]),
                        date: t, file: t.concat(["subtype", "multiple"]),
                    ...
                    var o = n[e];return "radio-group" === e && Object(p.u)("toggle", o), ["header", "paragraph", "button"].includes(e) && Object(p.u)("description", o), r || Object(p.u)("value", o), o || t;
                }(n),
                    a = {
                    ...
                    inline: function inline() {
                        var e = { first: f.a.get("inline"), second: f.a.get("inlineDesc", n.replace("-group", "")) };return I("inline", t, e);
                    },
                    ...
                    access: function access() {
                        ...
                        var a = { first: f.a.get("roles"), second: f.a.get("limitRole"), content: n.join("") };return I("access", t, a);
                    },
                    others: function others() {
                        return I("others", t, { first: f.a.get("enableOther"), second: f.a.get("enableOtherMsg") });
                    },
                    ...
                    multiple: function multiple() {
                        var e = { default: { first: "Multiple", second: "set multiple attribute" }, file: { first: f.a.get("multipleFiles"), second: f.a.get("allowMultipleFiles") }, select: { first: " ", second: f.a.get("selectionsMessage") } };return I("multiple", t, e[n] || e.default);
                    }
                },
                    s = void 0 !== t.role ? t.role.split(",") : [];["min", "max", "step"].forEach(function (e) {
                    a[e] = function () {
                        return P(e, t);
                    };
                });var u = ["name", "className"];if (Object.keys(i).forEach(function (t) {
                    var r = i[t],
                        l = [!0],
                        s = e.disabledAttrs.includes(r);if (e.typeUserDisabledAttrs[n]) {
                        var f = e.typeUserDisabledAttrs[n];l.push(!f.includes(r));
                    }if (e.typeUserAttrs[n]) {
                        var c = Object.keys(e.typeUserAttrs[n]);l.push(!c.includes(r));
                    }s && !u.includes(r) && l.push(!1), l.every(Boolean) && o.push(a[r](s));
                }), e.typeUserAttrs[n]) {
                    var c = function (e, t) {
                        var r = [],
                            n = { array: M, string: F, number: P, boolean: function boolean(e, r) {
                                var n,
                                    o = !1;return t.hasOwnProperty(e) ? o = t[e] : (r.hasOwnProperty("value") || r.hasOwnProperty("value")) && (o = r.value || r.checked || !1), I(e, function (e) {
                                    for (var t = 1; t < arguments.length; t++) {
                                        var r = null != arguments[t] ? arguments[t] : {},
                                            n = Object.keys(r);"function" == typeof Object.getOwnPropertySymbols && (n = n.concat(Object.getOwnPropertySymbols(r).filter(function (e) {
                                            return Object.getOwnPropertyDescriptor(r, e).enumerable;
                                ...
                                }({}, r, ((n = {})[e] = o, n)), { first: r.label });
                            } };for (var o in e) {
                            if (e.hasOwnProperty(o)) {
                                var i = R(o, e[o]),
                                    a = f.a.get(o),
                                    s = e[o],
                                    u = s.value || "";s.value = t[o] || s.value || "", s.label && (l[o] = Array.isArray(s.label) ? f.a.get.apply(f.a, s.label) || s.label[0] : s.label), n[i] && r.push(n[i](o, s)), l[o] = a, s.value = u;
                            }
                        }return r.join("");
                    }(e.typeUserAttrs[n], t);o.push(c);
                }return o.join("");
            };function R(e, t) {
                ...
                var r = t.class,
                    ...
                    i = {
                    id: e + "-" + b.lastID, title: o.description || o.label || e.toUpperCase(), name: e, type: o.type || "text",
                ...
                var r = t.multiple,
                    ...
                    var t = { value: e },
                        r = n[e],
                        o = Array.isArray(r) ? f.a.get.apply(f.a, r) || r[0] : r;return (Array.isArray(i) ? i.includes(e) : e === i) && (t.selected = null), O("option", o, t);
                }),
                    d = { id: e + "-" + b.lastID, title: u.description || o || e.toUpperCase(), name: e, className: ("fld-" + e + " form-control " + (a || s || "")).trim() };r && (d.multiple = !0);
                ...
                var n = function n(t) {
                    ...
                    o = { type: "checkbox", className: "fld-" + e, name: e, id: e + "-" + b.lastID };t[e] && (o.checked = !0);var i = [],
                    a = [O("input", null, o).outerHTML];
                return r.first && i.push(n(r.first)), r.second && a.push(" ", n(r.second)), r.content && a.push(r.content), a = O("div", a, { className: "input-wrap" }).outerHTML, O("div", i.concat(a), { className: "form-group " + e + "-wrap" }).outerHTML;
            },
                z = function z(e) {
                var t = "";"undefined" === e && (e = "default");var r = "<label>" + l.style + "</label>";return t += A.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML, t += '<div class="btn-group" role="group">', m.d.btn.forEach(function (r) {
                    var n = ["btn-xs", "btn", "btn-" + r];e === r && n.push("selected");var o = O("button", f.a.get("styles.btn." + r), { value: r, type: "button", className: n.join(" ") }).outerHTML;t += o;
                ...
                var n = r.map(function (r, n) {
                    ...
                    s = O("select", n, o),
                    u = O("div", s, { className: "input-wrap" });return O("div", [a, u], { className: "form-group " + o.name + "-wrap" }).outerHTML;
            },
                H = function H(t, r, n) {
                void 0 === n && (n = !1);
                var o = r[t] || "",
                ...
                if (![].some(function (e) {
                    ...
                    var c = '<div class="input-wrap">' + l + "</div>",
                        d = n ? "none" : "block";"value" === t && (d = r.subtype && "quill" === r.subtype && "none"), l = O("div", [u, c], { className: "form-group " + t + "-wrap", style: "display: " + d });
                }return l.outerHTML;
            },
                Q = function Q(e) {
                var t = e.type,
                    r = [],
                    n = "";return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some(function (e) {
                    return !0 === e;
                }) || (n = I("required", e, { first: f.a.get("required") })), n;
            },
                V = function V(t, n) {
                ...
                var i = t.type || "text",
                    ...
                    u = [O("a", null, { type: "remove", id: "del_" + b.lastID, className: "del-button btn icon-cancel delete-confirm", title: f.a.get("removeMessage") }), O("a", null, { type: "edit", id: b.lastID + "-edit", className: "toggle-form btn icon-pencil", title: f.a.get("hide") }), O("a", null, { type: "copy", id: b.lastID + "-copy", className: "copy-button btn icon-copy", title: f.a.get("copyButtonTooltip") })];s && Array.isArray(s) && (u = u.filter(function (e) {
                    return !s.includes(e.type);
                }));var c = [O("div", u, { className: "field-actions" })];c.push(O("label", Object(p.t)(a), { className: "field-label" })), c.push(O("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));var d = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };c.push(O("span", "?", d)), c.push(O("div", "", { className: "prev-holder" }));var m = O("div", [B(t), O("a", f.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                    g = O("div", m, { id: b.lastID + "-holder", className: "frm-holder", dataFieldId: b.lastID });o.currentEditPanel = g, c.push(g);var v = O("li", c, { class: i + "-field form-field", type: i, id: b.lastID }),
                    y = r(v);y.data("fieldData", { attrs: t }), void 0 !== A.stopIndex ? r("> li", h.stage).eq(A.stopIndex).before(y) : q.append(y), r(".sortable-options", y).sortable({ update: function update() {
                        return A.updatePreview(y);
                    } }), A.updatePreview(y), e.typeUserEvents[i] && e.typeUserEvents[i].onadd && e.typeUserEvents[i].onadd(v), n && (e.editOnAdd && (A.closeAllEdit(), A.toggleEdit(b.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({ behavior: "smooth" }));
            },
                Y = function Y(e, t, r) {
                var n = { selected: r ? "checkbox" : "radio" },
                    o = ["value", "label", "selected"],
                    i = [];t = Object.assign({ selected: !1, label: "", value: "" }, t);for (var a = o.length - 1; a >= 0; a--) {
                    var l = o[a];if (t.hasOwnProperty(l)) {
                        var s = { type: n[l] || "text", className: "option-" + l, value: t[l], name: e + "-option" };s.placeholder = f.a.get("placeholder." + l) || "", "selected" === l && !0 === t.selected && (s.checked = t.selected), i.push(O("input", null, s));
                    }
                }var u = { className: "remove btn icon-cancel", title: f.a.get("removeMessage") };return i.push(O("a", null, u)), O("li", i).outerHTML;
            },
                W = [".form-elements input", ".form-elements select", ".form-elements textarea"].join(", ");q.on("change blur keyup click", W, i()(function (e) {
                if (e) {
                    if ([function (e) {
                        var t = e.type,
                            r = e.target;return "keyup" === t && "className" === r.name;
                    }].some(function (t) {
                        return t(e);
                    })) return !1;A.updatePreview(r(e.target).closest(".form-field")), A.save.call(A);
                }
            }, 333, { leading: !1 })), q.on("click touchstart", ".remove", function (t) {
                var n = r(t.target).parents(".form-field:eq(0)"),
                    o = n[0],
                    i = o.getAttribute("type"),
                    a = r(t.target.parentElement);t.preventDefault(), o.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox") ? e.notify.error("Error: " + f.a.get("minOptionMessage")) : a.slideUp("250", function () {
                    a.remove(), A.updatePreview(n), A.save.call(A);
                });
            }), q.on("touchstart", "input", function (e) {
                var t = r(n);if (!0 === e.handled) return !1;if ("checkbox" === t.attr("type")) t.trigger("click");else {
                    t.focus();var o = t.val();t.val(o);
                }
            }), q.on("click touchstart", ".toggle-form, .close-field", function (e) {
                if (e.stopPropagation(), e.preventDefault(), !0 === e.handled) return !1;
                var t = r(e.target).parents(".form-field:eq(0)").attr("id");A.toggleEdit(t), e.handled = !0;
                ...
                if (!["select", "input", "label"].includes(e.target.tagName.toLowerCase()) && "true" !== e.target.contentEditable && (e.stopPropagation(), e.preventDefault(), !0 !== e.handled)) {
                    var t = "li" == e.target.tagName ? r(e.target).attr("id") : r(e.target).closest("li.form-field").attr("id");A.toggleEdit(t), e.handled = !0;
                }
            }), q.on("change", '[name="subtype"]', function (e) {
                var t = r(e.target).closest("li.form-field");r(".value-wrap", t).toggle("quill" !== e.target.value);
            });
            if (q.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), function (e) {
                ...
                if (!e.target.classList.contains("other-option")) {
                    ...
                    if (["select", "checkbox-group", "radio-group"].includes(r.type)) {
                        ...
                        var o = document.getElementById("value-" + r.id);o && (o.value = e.target.value);
                    }A.save.call(A);
                }
            }), Object(p.a)(h.stage, "keyup change", function (e) {
                var t = e.target;if (t.classList.contains("fld-label")) {
                    var r = t.value || t.innerHTML;Object(p.e)(t, ".form-field").querySelector(".field-label").innerHTML = Object(p.t)(r);
                }
            }), q.on("keyup", "input.error", function (e) {
                var t = e.target;return r(t).removeClass("error");
            }), q.on("keyup", 'input[name="description"]', function (e) {
                var t = r(e.target).parents(".form-field:eq(0)"),
                    n = r(".tooltip-element", t),
                    o = r(e.target).val();if ("" !== o) {
                    if (n.length) n.attr("tooltip", o).css("display", "inline-block");else {
                        var i = '<span class="tooltip-element" tooltip="' + o + '">?</span>';r(".field-label", t).after(i);
                    }
                } else n.length && n.css("display", "none");
            }), q.on("change", ".fld-multiple", function (e) {
                var t = e.target.checked ? "checkbox" : "radio",
                    n = r(".option-selected", r(e.target).closest(".form-elements"));return n.each(function (e) {
                    return n[e].type = t;
                }), t;
                ...
                t.preventDefault();var n = r(t.target).parent().parent("li"),
                    o = function (t) {
                    var n = t.attr("id"),
                        o = t.attr("type"),
                        i = o + "-" + new Date().getTime(),
                        a = t.clone();return r(".fld-name", a).val(i), a.find("[id]").each(function (e, t) {
                        t.id = t.id.replace(n, b.lastID);
                    }), a.find("[for]").each(function (e, t) {
                        var r = t.getAttribute("for").replace(n, b.lastID);t.setAttribute("for", r);
                ...
                }(n);o.insertAfter(n), A.updatePreview(o), A.save.call(A);
            }), q.on("click touchstart", ".delete-confirm", function (t) {
                t.preventDefault();var n = t.target.getBoundingClientRect(),
                    o = document.body.getBoundingClientRect(),
                    i = { pageX: n.left + n.width / 2, pageY: n.top - o.top - 12 },
                    a = r(t.target).parents(".form-field:eq(0)").attr("id"),
                    l = r(document.getElementById(a));if (document.addEventListener("modalClosed", function () {
                    l.removeClass("deleting");
                }, !1), e.fieldRemoveWarn) {
                    var s = O("h3", f.a.get("warning")),
                        u = O("p", f.a.get("fieldRemoveWarning"));A.confirm([s, u], function () {
                ...
                var t = r(e.target),
                    ...
                    o = t.val(),
                    i = r(".btn-style", n);i.val(o), t.siblings(".btn").removeClass("selected"), t.addClass("selected"), A.updatePreview(i.closest(".form-field")), A.save();
                ...
                var t = r(e.target).closest(".form-field").find(".available-roles"),
                    n = r(e.target);t.slideToggle(250, function () {
                    n.is(":checked") || r("input[type=checkbox]", t).removeAttr("checked");
                });
            }), q.on("click", ".add-opt", function (e) {
                e.preventDefault();var t = r(e.target).closest(".field-options"),
                    n = r('[name="multiple"]', t),
                    o = r(".option-selected:eq(0)", t),
                    i = !1;i = n.length ? n.prop("checked") : "checkbox" === o.attr("type");var a = o.attr("name").replace(/-option$/, "");r(".sortable-options", t).append(Y(a, !1, i));
                ...
                var J = document.getElementsByClassName("formBuilder-injected-style");Object(p.i)(J, function (e) {
                    return Object(a.f)(J[e]);
                });
            }return document.dispatchEvent(c.a.loaded), o.actions = { getFieldTypes: function getFieldTypes(t) {
                ...
                }, showData: A.showData.bind(A), save: A.save.bind(A), addField: function addField(e, t) {
                    A.stopIndex = b.formData.length ? t : void 0, S(e);
                }, removeField: A.removeField.bind(A), getData: A.getFormData.bind(A), setData: function setData(e) {
                    ...
                    (Array.isArray(e) ? e : [e]).forEach(function (e) {
                        ["number", "string"].includes(typeof e === "undefined" ? "undefined" : _typeof(e)) && ("number" == typeof e ? e = h.stage.children[e].id : /^frmb-/.test(e) || (e = h.stage.querySelector(e).id), A.toggleEdit(e));
                    });
                }, toggleAllFieldEdit: function toggleAllFieldEdit() {
                    Object(p.i)(h.stage.children, function (e) {
                        A.toggleEdit(h.stage.children[e].id);
                    });
                }, closeAllFieldEdit: A.closeAllEdit.bind(A), getCurrentFieldId: function getCurrentFieldId() {
                    return b.lastID;
            ...
            init: function init(e, t) {
                var r = jQuery.extend({}, m.c, e, !0),
                    n = r.i18n,
                    o = w(r, ["i18n"]);m.a.opts = o;
                var i = jQuery.extend({}, m.b, n, !0);
                return O.instance = {
                    actions: {
                        getFieldTypes: null, addField: null, clearFields: null, closeAllFieldEdit: null, getData: null, removeField: null, save: null, setData: null, setLang: null, showData: null, toggleAllFieldEdit: null, toggleFieldEdit: null,
                    ...
                    promise: new Promise(function (e, r) {
                        f.a.init(i).then(function () {
                            t.each(function (e) {
                                var r = new A(o, t[e], jQuery);jQuery(t[e]).data("formBuilder", r), Object.assign(O, r.actions), O.instance.actions = r.actions;
            ...
            void 0 === e && (e = {});var t = "string" == typeof e;if (!t) {
                var r = O.init(e, this);return Object.assign(O, r), r;
            }if (O[e]) {
