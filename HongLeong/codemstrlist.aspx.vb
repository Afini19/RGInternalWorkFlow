...
Partial Public Class codemstrlist_class
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        pFieldNames = " cm_fieldname,cm_filter "
        pJoinFields = ""
        Orderby = " group by cm_fieldname,cm_filter "
    ...
    Protected Sub rep_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rep.ItemDataBound
        ...
        If Not objdata Is Nothing Then
            objdata.Text = drv.Row("cm_fieldname").ToString.Trim & ""
        End If
