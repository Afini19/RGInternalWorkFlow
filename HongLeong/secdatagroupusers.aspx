...
<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="secdatagroupusers.aspx.vb" Inherits="secdatagroupusers_class" %>
                        ...
                        <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="cssdetail">Report To</th>
                                </tr>
                            </thead>
                            <tbody>
