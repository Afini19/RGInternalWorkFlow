<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="codemstritemlist.aspx.vb" Inherits="codemstritemlist_class" %>
                        ...
                        <div class="card" style="text-align: left;">
                            ...
                            <div id="opt" class="collapse">
                                <div class="card-body">
                                    ...
                                    <br />
                                    <asp:Button ID="btnback" CssClass="btn btn-info btn-sm w-100" Text="Back to Listing" runat="server" OnClick="backpage" CausesValidation="false" />
                                    <br />
                                    <br />
                                    <b>Messages:</b><br />
                        ...
                        <table id="table_listing" class="table table-borderless dt-responsive nowrap" width="100%" style="height: 100%; font-size: 0.8rem;" cellpadding="2" cellspacing="1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;" class="cssdetail">Description</th>
                                    ...
                                    <ItemTemplate>
                                        <tr id="trRow" class="ui-widget-content" runat="server">
                                            ...
                                            <td class="cssdetail" style="border-bottom: solid 1px silver" width="20%">
                                                <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "cm_id")%>' CommandName="Edit">Edit</asp:LinkButton>
                                                <asp:Literal ID="litSepDel" runat="server">|</asp:Literal>
                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "cm_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure want to delete this record?')">Delete</asp:LinkButton>
